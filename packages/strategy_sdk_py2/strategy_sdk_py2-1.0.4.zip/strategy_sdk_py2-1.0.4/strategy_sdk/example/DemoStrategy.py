...
if __name__ == "__main__":
    from config import quote_config, trader_config
    ...
    # 查询用户的帐号详情
    print simple_strategy.req_account_detail()[1].to_json()
    # 查询用户的持仓详情
    print simple_strategy.req_position_statics()[1].to_json()
    #查询用户在某个策略上的持仓详情
    print simple_strategy.req_position_statics(trader_config.strategyConnectionInfo.strategyId)[1].to_json()
    #查询用户的委托的订单列表

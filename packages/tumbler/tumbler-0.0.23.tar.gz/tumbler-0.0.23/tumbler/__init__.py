...
def json_representation(data, code, headers={}, allow_origin='*', allow_credentials=True, max_age=60 * 5):
    set_cors_into_headers(headers, allow_origin, allow_credentials, max_age)

...
# Target: PythonLibrary(BuildFileAddress(FilesystemBuildFile(/Users/atollenaere/workspace/commons/src/python/twitter/common/http/BUILD), http))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'twitter.common.lang==0.3.5',

...
class RDFGraphTCMixIn(object):
    ...
    def test_triples(self):
        ...
        self.assertEqual(triples, self._triples)
    ...
    def assertRoundTrip(self, rdf_format='xml'):
        with NamedTemporaryFile(delete=False) as fobj:
            try:
                ...
                os.unlink(fobj.name)
        self.assertEqual(set(graph.triples()), self._triples)
...
class RDFLibRDFGraphTC(RDFGraphTCMixIn, TestCase):
    ...
    def setUp(self):
        super(RDFLibRDFGraphTC, self).setUp()
...
class LibRDFRDFGraphTC(RDFGraphTCMixIn, TestCase):
    ...
    @require_module('RDF')
    def setUp(self):
        super(LibRDFRDFGraphTC, self).setUp()

...
from .lexer import Lambda, Var, Apply, Alias
...
def main(
    ...
    parser = LambdaParser(parseinfo=False)
    ast = parser.parse(
        text,
        startrule,
        filename=filename,
...
if __name__ == '__main__':
    import json
    ast = generic_main(main, LambdaParser, name='lambda')
    print('AST:')
    print(ast)
    print()
    print('JSON:')

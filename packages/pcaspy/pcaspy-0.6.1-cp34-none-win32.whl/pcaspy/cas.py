...
class gdd(_object):
    ...
    def getStatSevr(self): return _cas.gdd_getStatSevr(self)
    ...
    def dump(self): return _cas.gdd_dump(self)
    ...
    def putDD(self, *args): return _cas.gdd_putDD(self, *args)
    ...
    def __getitem__(self, *args): return _cas.gdd___getitem__(self, *args)
    __swig_getmethods__["createDD"] = lambda x: _cas.gdd_createDD
    if _newclass:createDD = staticmethod(_cas.gdd_createDD)
    def put(self, value):
...
def gdd_createDD(*args):
  return _cas.gdd_createDD(*args)
...
class PV(casPV):
    ...
    def getHighAlarmLimit(self, *args): return _cas.PV_getHighAlarmLimit(self, *args)
    def getLowAlarmLimit(self, *args): return _cas.PV_getLowAlarmLimit(self, *args)
    def getHighWarnLimit(self, *args): return _cas.PV_getHighWarnLimit(self, *args)
    def getLowWarnLimit(self, *args): return _cas.PV_getLowWarnLimit(self, *args)

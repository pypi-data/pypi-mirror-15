...
#      data_files = [('docs', ['rsMap3D/docs/index.rst', 
#                              'rsMap3D/docs/make.bat', 
#                              'rsMap3D/docs/Makefile', 
#                              'rsMap3D/docs/conf.py']),
#                    ('docs/Installation', ['rsMap3D/docs/Installation/linuxInstall.rst','rsMap3D/docs/Installation/windowsInstall.rst','rsMap3D/docs/Installation/macInstall.rst'])]
      )

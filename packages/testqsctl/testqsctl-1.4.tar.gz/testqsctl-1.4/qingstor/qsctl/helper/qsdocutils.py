...
COMMANDS = ('qsctl', 'qsctl-ls', 'qsctl-cp', 'qsctl-mb', 'qsctl-mv',
            'qsctl-rb', 'qsctl-rm', 'qsctl-sync')
...
def gen_rst_doc(command):
    ...
    # Discriptions and examples are in the 'source' directory.
...
def ignore_ctrl_c():
    # Ctrl-c shoule be ignored when use 'less -r' to print usage.

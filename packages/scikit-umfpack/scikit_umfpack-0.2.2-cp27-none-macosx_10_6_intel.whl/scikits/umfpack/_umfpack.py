...
def umfpack_dl_get_lunz(lnz, unz, n_row, n_col, nz_udiag, Numeric):
    """umfpack_dl_get_lunz(SuiteSparse_long * lnz, SuiteSparse_long * unz, SuiteSparse_long * n_row, SuiteSparse_long * n_col, SuiteSparse_long * nz_udiag, void * Numeric) -> SuiteSparse_long"""
    return __umfpack.umfpack_dl_get_lunz(lnz, unz, n_row, n_col, nz_udiag, Numeric)

def umfpack_zi_get_lunz(Numeric):
    """umfpack_zi_get_lunz(void * Numeric) -> int"""
    return __umfpack.umfpack_zi_get_lunz(Numeric)

def umfpack_zl_get_lunz(lnz, unz, n_row, n_col, nz_udiag, Numeric):
    """umfpack_zl_get_lunz(SuiteSparse_long * lnz, SuiteSparse_long * unz, SuiteSparse_long * n_row, SuiteSparse_long * n_col, SuiteSparse_long * nz_udiag, void * Numeric) -> SuiteSparse_long"""
    return __umfpack.umfpack_zl_get_lunz(lnz, unz, n_row, n_col, nz_udiag, Numeric)
...
def umfpack_dl_get_numeric(Lp, Lj, Lx, Up, Ui, Ux, P, Q, Dx, do_recip, Rs, Numeric):
    """umfpack_dl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, SuiteSparse_long * do_recip, double [] Rs, void * Numeric) -> SuiteSparse_long"""
    return __umfpack.umfpack_dl_get_numeric(Lp, Lj, Lx, Up, Ui, Ux, P, Q, Dx, do_recip, Rs, Numeric)
...
def umfpack_zl_get_numeric(Lp, Lj, Lx, Lz, Up, Ui, Ux, Uz, P, Q, Dx, Dz, do_recip, Rs, Numeric):
    """umfpack_zl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, double [] Lz, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, double [] Uz, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, double [] Dz, SuiteSparse_long * do_recip, double [] Rs, void * Numeric) -> SuiteSparse_long"""
    return __umfpack.umfpack_zl_get_numeric(Lp, Lj, Lx, Lz, Up, Ui, Ux, Uz, P, Q, Dx, Dz, do_recip, Rs, Numeric)

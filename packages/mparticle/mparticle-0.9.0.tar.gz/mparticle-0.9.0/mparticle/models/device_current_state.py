...
class DeviceCurrentState(object):
    ...
    def __init__(self):
        ...
        self._time_since_start_ms = None
        self._battery_level = None
        self._data_connection_type = None
        self._data_connection_type_detail = None
        self._gps_state = None
        self._total_system_memory_usage_bytes = None
        self._disk_space_free_bytes = None
        self._cpu = None
        self._system_memory_available_bytes = None
        self._system_memory_low = None
        self._system_memory_threshold_bytes = None
        self._application_memory_available_bytes = None
        self._application_memory_max_bytes = None
        self._application_memory_total_bytes = None
        self._device_orientation = None
        self._status_bar_orientation = None
    ...
    def device_orientation(self, device_orientation):
        ...
        if device_orientation not in allowed_values:
            raise ValueError(
                "Invalid value for `device_orientation`, must be one of {0}"
    ...
    def status_bar_orientation(self, status_bar_orientation):
        ...
        if status_bar_orientation not in allowed_values:
            raise ValueError(
                "Invalid value for `status_bar_orientation`, must be one of {0}"
                .format(allowed_values)
            )

...
class ApplicationStateTransitionEvent(object):
    ...
    def __init__(self):
        ...
        self._successfully_closed = None
        self._is_first_run = None
        self._is_upgrade = None
        self._push_notification_payload = None
        self._application_transition_type = None

    @classmethod
    def get_install_event(cls):
        event = cls()
    ...
    def application_transition_type(self, application_transition_type):
        ...
        if application_transition_type not in allowed_values:
            raise ValueError(
                "Invalid value for `application_transition_type`, must be one of {0}"

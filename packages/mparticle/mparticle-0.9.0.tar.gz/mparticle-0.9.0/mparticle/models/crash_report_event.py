...
class CrashReportEvent(object):
    ...
    def __init__(self):
        ...
        self._exception_handled = None
        self._topmost_context = None
        self._pl_crash_report_file_base64 = None
        self._ios_image_base_address = None
        self._ios_image_size = None

...
class PushMessageEvent(object):
    ...
    def __init__(self):
        ...
        self._push_message_token = None
        self._push_message_type = None
        self._message = None
        self._network = None
    ...
    def push_message_type(self, push_message_type):
        ...
        if push_message_type not in allowed_values:
            raise ValueError(
                "Invalid value for `push_message_type`, must be one of {0}"
    ...
    def application_state(self, application_state):
        ...
        if application_state not in allowed_values:
            raise ValueError(
                "Invalid value for `application_state`, must be one of {0}"
                .format(allowed_values)
            )

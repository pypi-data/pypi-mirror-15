...
class DeviceInformation(object):
    ...
    def __init__(self):
        ...
        self._device_country = None
        self._locale_language = None
        self._locale_country = None
        self._network_country = None
        self._network_carrier = None
        self._network_code = None
        self._network_mobile_country_code = None
        self._timezone_offset = None
        self._build_identifier = None
        self._http_header_user_agent = None
        self._ios_advertising_id = None
        self._push_token = None
        self._cpu_architecture = None
        self._is_tablet = None
        self._push_notification_sound_enabled = None
        self._push_notification_vibrate_enabled = None
        self._radio_access_technology = None
        self._supports_telephony = None
        self._has_nfc = None
        self._bluetooth_enabled = None
        self._bluetooth_version = None
        self._ios_idfv = None
        self._android_advertising_id = None
    ...
    def platform(self, platform):
        ...
        if platform not in allowed_values:
            raise ValueError(
                "Invalid value for `platform`, must be one of {0}"

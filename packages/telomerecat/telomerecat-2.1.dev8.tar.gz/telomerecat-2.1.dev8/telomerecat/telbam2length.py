    ...
    def run_read_stat_rule(self,path,
        ...
        def rule(reads,constants,master):
            ...
            for read in simple_reads:
                mima_counts[len(read.mima_loci),int(read.avg_qual)] += 1
            ...
            return {"read_array":np.array(return_dat),
...
class Telbam2Length(parabam.core.Interface):
    ...
    def run(self,input_paths,
        ...
        self.__output__(" Length estimation results will be written to the following file:\n",1)
    ...
    def __create_output_file__(self,output):
        ...
        output_csv_path = os.path.join(self.temp_dir,unqiue_file_ID)

...
from sql_query_helpers import get_sql_result, list_tables
...
def get_most_recent(table, column, howmany, where, source_db_conn_dict,
                    target_db_conn_dict, heavy, restriction_string,
                    include_only, overwrite):
...
def pull_data(table, column, column_values, source_db_conn_dict,
              target_db_conn_dict, heavy, restriction_string, include_only,
              overwrite):

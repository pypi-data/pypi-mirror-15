...
#------------------------------------------------------------------------#
    ...
    def createPanel(self):
        ...
        self.calcbtn = wx.Button(panel ,id = ID_CALCBTN, label = '&Calculate', size = (110, 48))
        self.exitbtn = wx.Button(panel ,id = ID_EXITBTN, label = 'E&xit',      size = (110, 48))
        self.plotbtn = wx.Button(panel, id = ID_PLOTBTN, label = 'Show &Plot', size = (110, 48))
...
#------------------------------------------------------------------------#
    ...
    def onSaveData(self, event):
        ...
        savedataframe.SetMinSize((490, 400))
        savedataframe.Show()
...
class DataSaveFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.data_pth_tc  = funutils.MyTextCtrl(panel, value=os.path.join(os.getcwd(), 'data.asc'), style=wx.CB_READONLY)
        ...
        gbs.Add(data_fmt_st,  pos=(0, 0), span=(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.LEFT,  border=10)
        ...
        gbs.Add(self.data_pth_tc,  pos=(1, 1), span=(1, 1), flag=wx.LEFT | wx.EXPAND,            border=10)
        gbs.Add(data_pth_btn,  pos=(1, 2), span=(1, 1), flag=wx.LEFT | wx.RIGHT | wx.EXPAND,      border=10)
        gbs.Add(data_cols_st,  pos=(2, 0), span=(1, 3), flag=wx.ALIGN_CENTER_VERTICAL | wx.LEFT,  border=10)
        gbs.Add(data_cols_ws,  pos=(3, 0), span=(3, 3), flag=wx.LEFT | wx.RIGHT | wx.EXPAND,      border=10)
        gbs.Add(data_save_btn, pos=(1, 4), span=(1, 1), flag=wx.RIGHT, border=10)
        ...
        self.Bind(wx.EVT_BUTTON, self.onSave, data_save_btn)
    ...
    def onSave(self, event):
        ...
        dial = wx.MessageDialog(self, message = 'Saved data to ' + self.filename, caption = "Data Saved Message", style = wx.OK)
        if dial.ShowModal() == wx.ID_YES:
            self.Destroy()

...
setup(
        name            = 'grr-chipsec',
        description     = 'CHIPSEC: Platform Security Assessment Framework Fork of https://github.com/chipsec/chipsec with minor changes for GRR',
        version         = '1.2.2',
        author          = 'Thiebaud Weksteen',
        author_email    = 'tweksteen@gmail.com',
        url             = 'https://github.com/tweksteen/chipsec/commits/userland_linux_with_clean_up',

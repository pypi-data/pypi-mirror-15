...
class Table(_Component):
    ...
    def __init__(self, table_id=None, columns=None, defaultSort=None, filters=None, searchBoxAttributes=None,
        ...
        super(Table, self).__init__(analysis=analysis, component_id=component_id, component_type=component_type)
    ...
    def _fields(self):
        return super(Table, self)._fields() + [ 'table_id', 'columns', 'defaultSort', 'filters', 'searchBoxAttributes', 'pageSizes', 'searchBoxPlaceholder', 'striped', 'title' ]

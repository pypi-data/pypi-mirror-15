...
class TableBuilder(object):
    ...
    :param numpy 2Darray, pandas DataFrame or List of columns data: table data
    ...
    :param List of str column_names: names of each column
    ...
    def __init__(self, data, title, default_rows_per_page = 10, column_names = [], striped = True, search_box_place_holder = 'Search'):
        self._table_id = None
        self._table_component_id = None
    ...
    @property
    def _component_id(self):  # to make it looks like a component to the rest of Python API
        return self._table_component_id
    ...
    def _get_table_data(self):
        ...
        for col_obj in self._columns:
            cols_data, cols_name, cols_comp = col_obj._get_data_columns()
            ...
            if row_components_col and cols_comp:
    ...
    def _get_table_component(self, table_id, analysis = None):
        title_comp_ref, _ = formatted_text._get_component_ref_and_defs_for_value(self.title, analysis)
        ...
        for col_obj in self._columns:
            ...
            if not col_obj.filter_only:
                header_comp_ref, _ = formatted_text._get_component_ref_and_defs_for_value(col_obj.column_header, analysis)
                columns.append({
        ...
        page_sizes = [self.default_rows_per_page] + list(set(self.ALLOWED_ROWS_PER_PAGE) - {self.default_rows_per_page})
    ...
    def _associate(self, analysis):
        ...
        resp = analysis._eureqa._session.execute(endpoint, method='POST', args=self._get_table_data())
        ...
        self._table_component_id = table_component._component_id

...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  `[File Locations]'
  + `tv dir: FILEPATH'
       If you use the transmission_done.py or deluge_done.py scripts,
    then this is where the finished video files will be copied to and

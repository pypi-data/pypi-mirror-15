...
DATA_PATH_1 = os.path.join(this_dir, "divyansh.py")
DATA_PATH_2 = os.path.join(this_dir, "divyansh2.py")
DATA_PATH_3 = os.path.join(this_dir, "divyansh3.py")
# END EXCLUDE
...
def gen_depth_sub_grade_list(year, dep, msc_dep_bool, sub_dict):
    ...
    if msc_dep_bool:
        last5 = 20000
    tmp = 28                                                                #######################
    names = [DATA_PATH_1, DATA_PATH_2, DATA_PATH_3]       #######################
    while tmp != 0:             #######################
        tmp -= 1                ######################
        last5 += 1

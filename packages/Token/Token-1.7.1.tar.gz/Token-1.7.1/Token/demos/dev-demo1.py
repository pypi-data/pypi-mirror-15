...
access = BankFIDOR.create_access('1008', '1008', pk1)
...
access2 = BankBBVA.create_access('1008', '1008', pk2)
...
Token.set_context(alice, sk1)
payment = ProviderFIDOR.create_payment(token2.id, alice_acc.id, 0.02, "EUR",
                                       description="Order 5672, Bob refund")
ProviderFIDOR.get_account(alice_acc.id)

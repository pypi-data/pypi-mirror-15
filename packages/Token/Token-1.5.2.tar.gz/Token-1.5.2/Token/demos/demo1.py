...
access = BankFIDOR.create_access('1008', '1008', 'fidor')

Token.set_context('bank-bbva', Token.keys["bankBBVA"])
access2 = BankBBVA.create_access('1008', '1008', 'bbva')
...
Token.set_context(bob, sk2)
payment = ProviderBBVA.create_payment(token.id, bob_acc.id, 2, "EUR")

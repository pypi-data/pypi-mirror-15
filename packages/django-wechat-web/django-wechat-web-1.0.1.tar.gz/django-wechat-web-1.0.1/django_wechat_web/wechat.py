...
class WechatWeb:
    ...
    def validate_code(self):
        return not self._validate_code
    ...
    def redirect(self):
        ...
        assert self._scope != None, 'scope cannot be none'
        assert self._state in ['snsapi_base', 'snsapi_userinfo'], 'Invalid Scope. Scope must be snsapi_base or snsapi_userinfo'
    ...
    def get_openid(self):
        return self._get_data('openid', None)

    def set_scope(self, scope):
        self.scope = scope
        self.state = scope.replace('_', '')

...
class FaceSession(object):
    ...
    def __init__(self, db_manager):
        ...
        self.session_sigs_2d_nparray = np.empty((0, self.SIGNATURE_LEN), np.uint8)
    ...
    def add_face(self, myme_face_id, detected_time, signature):
        ...
        faces. This is useful in case where the user requests to get all faces.
    ...
    def compare_session_sigs_to_person_sigs(self, session_sigs_2d_np_array,
        ...
        dist_matrix = self.calc_distances(
                session_sigs_2d_np_array, person_sigs_np_array)
        # Computes the 40th percentile value between flattened
        # session_sigs_2d_np_array and person_sigs_np_array

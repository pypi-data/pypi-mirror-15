...
class MyMeFace(object):
    ...
    image was requested using :meth:`MyMeSDK.client.api.request_image_for_face_id`
...
class MyMePerson(object):
    ...
    name = None
    """ Name of the person, if given using :meth:`MyMeSDK.client.api.set_name_to_person'`,
    None otherwise """

    profile_pic = None
    """ Profile picture of the person, if set using :meth:`MyMeSDK.client.api.set_profile_picture'`,
    None otherwise"""

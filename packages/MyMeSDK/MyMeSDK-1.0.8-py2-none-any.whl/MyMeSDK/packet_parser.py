...
class PacketParser(object):
    ...
    def _parse_packet_header(packet):
        ...
        # <B means little endian unsigned byte (in python this becomes an regular int)
    ...
    def parse_face_signature_packet(packet):
        ...
        # parse header
        flag, size, myme_face_id, timestamp, payload = \
            PacketParser._parse_packet_header(packet)
        if flag is None:
            return None
        ...
        return myme_face_id, timestamp, signature_int_array, flag

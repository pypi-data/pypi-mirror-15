...
def initialize(verbose=False, auto_create_new_person=False):
    """
    ...
    :param auto_create_new_person:
                ...
                This setting can be toggled by calling this function:
                :meth:`MyMeSDK.api.set_new_person_auto_creation_mode`
    :return: None

...
class MyMeCommands(IntEnum):
    CommandShutdown = 0
    CommandEnterPowerMode = 1
    CommnadExitPowerMode  = 2
...
class ServiceUUID(Enum):
    ...
    CommandService                      = "0b21aba6-68a2-4902-a6ed-8f6d2238a5a3"
...
COMMAND_SERVICE_UUID                  = "0b21aba6-68a2-4902-a6ed-8f6d2238a5a3"
COMMAND_CHARACTERISTIC_UUID           = "d095fcec-3ee0-4164-a6c3-51a2b0a3085c"
...
# source: zsearch_definitions/protocols.proto
...
_SUBPROTOCOL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SPF', index=49, number=220,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_DMARC', index=50, number=221,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_DKIM', index=51, number=222,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_A', index=52, number=223,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_MX', index=53, number=224,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_AXFR', index=54, number=225,
      options=None,
      type=None),
  ],
  containing_type=None,

...
# source: zsearch_definitions/rpc.proto
...
_MINSCANID.fields_by_name['key'].message_type = zsearch__definitions_dot_hoststore__pb2._ANONYMOUSKEY
...
_PRUNESTATISTICS.fields_by_name['key'].message_type = zsearch__definitions_dot_hoststore__pb2._ANONYMOUSKEY
...
_HOSTQUERYRESPONSE.fields_by_name['record'].message_type = zsearch__definitions_dot_hoststore__pb2._RECORD
_HOSTQUERYRESPONSE.fields_by_name['records'].message_type = zsearch__definitions_dot_hoststore__pb2._RECORD
...
_ANONYMOUSQUERYRESPONSE.fields_by_name['record'].message_type = zsearch__definitions_dot_anonstore__pb2._ANONYMOUSRECORD
_ANONYMOUSQUERYRESPONSE.fields_by_name['records'].message_type = zsearch__definitions_dot_anonstore__pb2._ANONYMOUSRECORD
_ANONYMOUSQUERYRESPONSE_RESPONSESTATUS.containing_type = _ANONYMOUSQUERYRESPONSE
_USERDATAREQUEST.fields_by_name['data'].message_type = zsearch__definitions_dot_common__pb2._USERDATAATOM
...
_ROOTSTOREREPLY.fields_by_name['certificates'].message_type = zsearch__definitions_dot_anonstore__pb2._CERTIFICATE
...
MinScanId = _reflection.GeneratedProtocolMessageType('MinScanId', (_message.Message,), dict(
  ...
  __module__ = 'zsearch_definitions.rpc_pb2'
...
_SERVERSTATISTICS_STORESTATISTICSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_SERVERSTATISTICS_ANONYMOUSSTORESTATISTICSENTRY.has_options = True
_SERVERSTATISTICS_ANONYMOUSSTORESTATISTICSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
import abc

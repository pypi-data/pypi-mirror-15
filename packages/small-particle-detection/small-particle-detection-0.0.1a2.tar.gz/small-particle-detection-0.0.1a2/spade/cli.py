...
args.add_argument('--shapes-library', '-s',
                  dest='shapes_library',
                  type=str,
                  default='potatoids_5x5__smallest_3_pix',
                  help='The shapes library to use.\n'
                       'Default is potatoids_5x5__smallest_3_pix. Possibles '
                       'choices: potatoids_5x5__smallest_1_pix to ...4_pix,'
                       'potatoids_3x3_smallest_1_pix to ...4_pix')
...
try:
    exec('from spade.shapes.library import {} as shapes_library'.format(
        args.shapes_library))
except ImportError:

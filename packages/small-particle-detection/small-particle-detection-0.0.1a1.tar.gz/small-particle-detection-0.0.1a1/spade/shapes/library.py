...
potatoids_array = np.load(join(local_dir, 'potatoids_5x5.npz'))['arr_0.npy']
potatoids_5x5__smallest_1_pix = ShapesLibrary(potatoids_array,
                                              name='Potatoids 5x5, 1 to 25px',
                                              sort=False)
potatoids_5x5__smallest_2_pix = ShapesLibrary(potatoids_array[1:],
                                              name='Potatoids 5x5, 2 to 25px',
                                              sort=False)
potatoids_5x5__smallest_3_pix = ShapesLibrary(potatoids_array[3:],
                                              name='Potatoids 5x5, 3 to 25px',
                                              sort=False)
potatoids_5x5__smallest_4_pix = ShapesLibrary(potatoids_array[7:],

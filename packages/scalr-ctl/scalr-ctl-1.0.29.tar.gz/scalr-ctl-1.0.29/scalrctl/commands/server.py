...
class RebootServer(commands.Action):
    ...
    epilog = "Example: scalr-ctl server reboot --serverId <ID> --hard-reboot"
    ...
    def get_options(self):
        ...
        hard_reboot = click.Option(('--hard-reboot', 'hard'), is_flag=True, default=False, help=hlp)
...
class TerminateServer(commands.Action):
    ...
    epilog = "Example: scalr-ctl server terminate --serverId <ID> --hard-terminate"
    post_template = {
    ...
    def get_options(self):
        ...
        hard_terminate = click.Option(('--hard-terminate', 'hard'), is_flag=True, default=False, help=hlp)

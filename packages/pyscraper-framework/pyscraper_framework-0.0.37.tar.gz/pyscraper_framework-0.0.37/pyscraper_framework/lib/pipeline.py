import os
# from .etl_job import ETLJob as ETLJob
...
class Pipeline():
    ...
    def init_etl_job(self, extractor=self.init_extractor(), transformer=self.init_transformer(), loader=self.init_loader(), **kwargs):

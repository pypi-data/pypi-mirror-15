...
setup(
    ...
    data_files=[('resources', ['quantulum/resources/clf.pickle',
                               'quantulum/resources/entities.json',
                               'quantulum/resources/units.json',
                               'quantulum/resources/wiki.json',
                               'quantulum/resources/train.json',
                               'quantulum/resources/tests.json'])],

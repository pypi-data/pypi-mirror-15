...
See:
`jinja2.Environment <http://jinja.pocoo.org/docs/dev/api/#jinja2.Environment>`__
...
https://pypi.python.org/pypi/HiYaPyCo. Unpack the archive and install by
executing:
...
use http://repo.zero-sys.net/hiyapyco/rpm as URL for the yum repo and
http://jwhoisserver.net/key.asc as the URL for the key.

Arch Linux
~~~~~~~~~~

An `AUR package <https://aur.archlinux.org/packages/python-hiyapyco/>`__
is available.

License
-------

(c) 2014 - 2016 Klaus Zerwes `zero-sys.net <https://zero-sys.net>`__
...
Merged: \* flatten mapping from Chris Petersen geek@ex-nerd.com \* arch
linux package info from Peter Crighton git@petercrighton.de
...
deb packages: \* removed support for python 2.6 \* include examples as
doc

...
parser.add_argument("-u", "--upload", help="upload a folder to Google Drive.")
parser.add_argument("-d", "--download", help="download a folder from Google Drive.")

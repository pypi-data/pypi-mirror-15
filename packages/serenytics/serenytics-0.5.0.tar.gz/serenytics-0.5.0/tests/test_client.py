...
class TestClient(object):
    ...
    def setup(self, serenytics_client, push_data_source):
        self._client = serenytics_client
        self._data_source = push_data_source

    def test_get_or_create_push_data_source_by_name(self):
        data_source = self._client.get_or_create_push_data_source_by_name(self._data_source.name)

...
class DataSource(object):
    ...
    def batch_push_data(self, rows):
        """
        Append several rows of data to current storage data source.
        ...
        """
        self._check_is_storage_source()
        reload_url = settings.SERENYTICS_API_DOMAIN + '/api/data_source/' + self.uuid + '/batch_push'
        make_request('post', reload_url, data=json.dumps(rows), headers=self._headers)

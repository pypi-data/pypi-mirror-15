...
class LoadMaster(HttpClient):
        ...
        for service_data in virtual_services_data:
            ...
            if master_vs_id != 0:
                for vs in virtual_services_data:
                    if int(vs.get("Index", 0)) == master_vs_id:
                        virt_serv = self.build_virtual_service(service_data, vs)
            else:
    ...
    def build_virtual_service(self, service, response):
        ...
        """
        asfdsfda = service.get('MasterVSID')
        ...
        if is_sub_vs:
            ...
            subvs_lb_props = get_sub_vs_list_from_data(response)[1]
            ...
            for vs in services:
                ...
                if vs['MasterVSID'] == this_vs_index:
                    ...
                    subvs_api_entries = get_dict_entry_as_list("SubVS", data)
    ...
    def backup(self, location='backups'):
        ...
        file_name = os.path.join(location, "{}.backup".format(self.ip_address))

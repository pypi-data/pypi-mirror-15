...
class Api(_CommonAPIClass):
	...
	class _Statistics(_CommonAPIClass):
		...
		#URL: statistics
		def Get(self, Type, Filter, Fromdate, Todate, Graphtype, Nb, Order, Groupby, Periodicity, Org, body=None, element_name=None, streamingResponseFile=None):
	...
	class _Users(_CommonAPIClass):
		...
		#URL: users
		def Create(self, Notify, Notifyadmin, Org, Publisher=None, Admin=None, Autopasswd=None, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Imports(_CommonAPIClass):
			...
			def Import(self, Appliancename, Applianceversion, Imported, Force, Reusebundles=None, Usemajor=None, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Galleries(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/users/' + str(self._get('Uid')) + '/galleries', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Migrations(_CommonAPIClass):
			...
			class _Scannedinstances(_CommonAPIClass):
				...
				class _Scans(_CommonAPIClass):
					...
					def Create(self, Acceptall, Crc, Name=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'acceptAll': Acceptall, 'crc': Crc, 'name': Name}
						return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans', 'POST', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/migrations/{mid}/scannedinstances/{siid}/scans
					def Createmultipart(self, Name, Acceptall, Crc, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'name': Name, 'acceptAll': Acceptall, 'crc': Crc}
						return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans', 'POST', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/migrations/{mid}/scannedinstances/{siid}/scans
					def Get(self, Ongoing, Includestats, Delta, Name=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'ongoing': Ongoing, 'includeStats': Includestats, 'delta': Delta, 'name': Name}
						return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/migrations/{mid}/scannedinstances/{siid}/scans/{sid}
					def Get(self, Pkgfiles, Dir, Rellevel, Delta, Comparewith, Validated=None, Pkgs=None, Added=None, body=None, element_name=None, streamingResponseFile=None):
						...
						return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
					class _Files(_CommonAPIClass):
						...
						def Get(self, Comparewith, Limit, Added, Pkgfiles, Dir, Rellevel, Delta, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'compareWith': Comparewith, 'limit': Limit, 'added': Added, 'pkgFiles': Pkgfiles, 'dir': Dir, 'rellevel': Rellevel, 'delta': Delta}
							return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/files', 'GET', body, element_name, streamingResponseFile, **kwargs)
					...
					class _Packages(_CommonAPIClass):
						...
						def Get(self, All, Comparewith, Excludefiles=None, Fromrepo=None, Uploaded=None, Notselected=None, body=None, element_name=None, streamingResponseFile=None):
							...
							return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/packages', 'GET', body, element_name, streamingResponseFile, **kwargs)
					...
					class _Overlay(_CommonAPIClass):
						...
						def Multipartupload(self, Crc, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'crc': Crc}
							return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/overlay', 'POST', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/migrations/{mid}/scannedinstances/{siid}/scans/{sid}/overlay
						def Upload(self, Crc, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'crc': Crc}
							return self._REST('/users/' + str(self._get('Uid')) + '/migrations/{mid}/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/overlay', 'POST', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Instances(_CommonAPIClass):
			...
			def Get(self, Refresh, Id=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'refresh': Refresh, 'id': Id}
				return self._REST('/users/' + str(self._get('Uid')) + '/instances', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Accounts(_CommonAPIClass):
			...
			class _Certs(_CommonAPIClass):
				...
				#URL: users/{uid}/accounts/{caid}/certs/{certid}
				def Get(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Appliances(_CommonAPIClass):
			...
			class _Osprofile(_CommonAPIClass):
				...
				class _Services(_CommonAPIClass):
					...
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/osprofile/' + str(self._get('Osid')) + '/services', 'GET', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Updates(_CommonAPIClass):
					...
					def Save(self, At, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'at': At}
			...
			class _Pimages(_CommonAPIClass):
				...
				class _Downloads(_CommonAPIClass):
					...
					def Download(self, Id, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'id': Id}
			...
			class _Sharedtemplates(_CommonAPIClass):
				...
				def Get(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, Parent=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset, 'parent': Parent}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/sharedTemplates', 'GET', body, element_name, streamingResponseFile, **kwargs)
				class _Statuses(_CommonAPIClass):
					def __init__(self, parent, **kwargs):
						self._parent = parent
						self.__dict__.update(kwargs)
					...
					def Get(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, Parent=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset, 'parent': Parent}
						return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/sharedTemplates/statuses', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Confmgmtplts(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/confmgmtplts/' + str(self._get('Cmid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/appliances/{aid}/confmgmtplts
				def Create(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/confmgmtplts', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/appliances/{aid}/confmgmtplts
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/confmgmtplts', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/appliances/{aid}/confmgmtplts/{cmid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/confmgmtplts/' + str(self._get('Cmid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/appliances/{aid}/confmgmtplts/{cmid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/confmgmtplts/' + str(self._get('Cmid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Images(_CommonAPIClass):
				...
				class _Pimages(_CommonAPIClass):
					...
					class _Instances(_CommonAPIClass):
						...
						def Delete(self, Force, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'force': Force}
							return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/appliances/{aid}/images/{itid}/pimages/{pitid}/instances/{riid}
						def Get(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/appliances/{aid}/images/{itid}/pimages/{pitid}/instances
						def Start(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances', 'POST', body, element_name, streamingResponseFile, **kwargs)
						class _States(_CommonAPIClass):
							...
							def Change(self, Action, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {'action': Action}
								return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '/states', 'PUT', body, element_name, streamingResponseFile, **kwargs)
						...
						class _Status(_CommonAPIClass):
							...
							def Get(self, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {}
								return self._REST('/users/' + str(self._get('Uid')) + '/appliances/' + str(self._get('Aid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Installprofile(_CommonAPIClass):
				...
				class _Groups(_CommonAPIClass):
					...
					def Deletegroup(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/groups/{osgid}
					def Updategroup(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/groups/{osgid}
					def Getgroup(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					def Deletegroups(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/groups
					def Getgroups(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/groups
					def Creategroup(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
				...
				class _Users(_CommonAPIClass):
					...
					def Deleteusers(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/users
					def Createuser(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					def Updateuser(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/users/{osuid}
					def Deleteuser(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/users
					def Getusers(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
					...
					#URL: users/{uid}/appliances/{aid}/installProfile/{ipid}/users/{osuid}
					def Getuser(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
		...
		class _Distros(_CommonAPIClass):
			...
			def Update(self, Org, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'org': Org}
		...
		class _Stats(_CommonAPIClass):
			...
			#URL: users/{uid}/stats
			def Get(self, Type, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'type': Type}
		...
		class _Mysoftware(_CommonAPIClass):
			...
			class _Pkgs(_CommonAPIClass):
				...
				class _Bin(_CommonAPIClass):
					...
					#URL: users/{uid}/mysoftware/{msid}/pkgs/{mspackid}/bin/{fileName}
					def Downloadfilename(self, Downloadid, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
		...
		class _Photo(_CommonAPIClass):
			...
			def Getfilename(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
		...
		class _Scans(_CommonAPIClass):
			...
			#URL: users/{uid}/scans
			def Get(self, Id=None, Index=None, Max=None, Orderby=None, Asc=None, body=None, element_name=None, streamingResponseFile=None):
			...
			#URL: users/{uid}/scans
			def Delete(self, Id=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'id': Id}
		...
		class _Activities(_CommonAPIClass):
			...
			def Getactivity(self, Type, Nblatestresults, Order, Fromdate, Todate, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Blueprints(_CommonAPIClass):
			...
			class _Zones(_CommonAPIClass):
				...
				def Getallzones(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/zones', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Logo(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/logo/' + str(self._get('Logoid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/logo/{logoId}/{fileName}
				def Upload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/logo/' + str(self._get('Logoid')) + '/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Exports(_CommonAPIClass):
				...
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/exports/{epid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/exports
				def Create(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/exports/{epid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				class _Images(_CommonAPIClass):
					...
					def Delete(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/{ovfid}', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					class _Status(_CommonAPIClass):
						def __init__(self, parent, **kwargs):
							self._parent = parent
							self.__dict__.update(kwargs)
						...
						def Get(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Ovfid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/blueprints/{bpid}/exports/{epid}/images/{ovfid}/status
						def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Ovfid')) + '/status', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					...
					class _Pimages(_CommonAPIClass):
						...
						def Get(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Epiid')) + '/pimages/' + str(self._get('Pitid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/blueprints/{bpid}/exports/{epid}/images/{epiid}/pimages
						def Publish(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Epiid')) + '/pimages', 'POST', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/blueprints/{bpid}/exports/{epid}/images/{epiid}/pimages/{pitid}
						def Delete(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Epiid')) + '/pimages/' + str(self._get('Pitid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
						class _Status(_CommonAPIClass):
							def __init__(self, parent, **kwargs):
								self._parent = parent
								self.__dict__.update(kwargs)
							...
							def Get(self, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {}
								return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Epiid')) + '/pimages/' + str(self._get('Pitid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
						...
						class _Cancel(_CommonAPIClass):
							...
							def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {}
								return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/images/' + str(self._get('Epiid')) + '/pimages/' + str(self._get('Pitid')) + '/cancel', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Status(_CommonAPIClass):
					...
					def Getstatus(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/blueprints/{bpid}/exports/status
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/blueprints/{bpid}/exports/{epid}/status
					def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/status', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Downloads(_CommonAPIClass):
					...
					def Download(self, Downloadid, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/exports/' + str(self._get('Epid')) + '/downloads', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Layers(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/layers
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/layers/{bplid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/layers
				def Create(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/blueprints/{bpid}/layers/{bplid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				class _Installprofile(_CommonAPIClass):
					...
					def Updateinstallprofile(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '/installProfile/' + str(self._get('Bpiid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Securitygroup(_CommonAPIClass):
					...
					def Delete(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '/securitygroup/' + str(self._get('Segid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/blueprints/{bpid}/layers/{bplid}/securitygroup
					def Create(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '/securitygroup', 'POST', body, element_name, streamingResponseFile, **kwargs)
					class _Rules(_CommonAPIClass):
						...
						def Delete(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '/securitygroup/' + str(self._get('Segid')) + '/rules/' + str(self._get('Ruid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: users/{uid}/blueprints/{bpid}/layers/{bplid}/securitygroup/{segid}/rules
						def Create(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/users/' + str(self._get('Uid')) + '/blueprints/' + str(self._get('Bpid')) + '/layers/' + str(self._get('Bplid')) + '/securitygroup/' + str(self._get('Segid')) + '/rules', 'POST', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Pimages(_CommonAPIClass):
			...
			def Get(self, Pimg=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'pimg': Pimg}
		...
		class _Scannedinstances(_CommonAPIClass):
			...
			#URL: users/{uid}/scannedinstances
			def Get(self, Delta, Mac=None, Name=None, Id=None, Index=None, Max=None, Orderby=None, Asc=None, Includescans=None, body=None, element_name=None, streamingResponseFile=None):
			...
			class _Scans(_CommonAPIClass):
				...
				def Get(self, Validated, Pkgs, Added, Pkgfiles=None, Dir=None, Rellevel=None, Delta=None, Comparewith=None, body=None, element_name=None, streamingResponseFile=None):
				...
				#URL: users/{uid}/scannedinstances/{siid}/scans/{sid}
				def Update(self, Acceptall, body=None, element_name=None, streamingResponseFile=None):
				...
				#URL: users/{uid}/scannedinstances/{siid}/scans
				def Create(self, Acceptall, Crc, Reportfilename, Name=None, body=None, element_name=None, streamingResponseFile=None):
				...
				#URL: users/{uid}/scannedinstances/{siid}/scans
				def Multipartcreate(self, Name, Acceptall, Crc, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'name': Name, 'acceptAll': Acceptall, 'crc': Crc}
					return self._REST('/users/' + str(self._get('Uid')) + '/scannedinstances/' + str(self._get('Siid')) + '/scans', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/scannedinstances/{siid}/scans
				def Getall(self, Includestats, Delta, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
				...
				class _Files(_CommonAPIClass):
					...
					def Get(self, Comparewith=None, Limit=None, Added=None, Pkgfiles=None, Dir=None, Rellevel=None, Delta=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'compareWith': Comparewith, 'limit': Limit, 'added': Added, 'pkgFiles': Pkgfiles, 'dir': Dir, 'rellevel': Rellevel, 'delta': Delta}
					...
					#URL: users/{uid}/scannedinstances/{siid}/scans/{sid}/files
					def Get(self, Limit=None, Comparewith=None, body=None, element_name=None, streamingResponseFile=None):
				...
				class _Rawparts(_CommonAPIClass):
					...
					def Upload(self, Partitionname, Crc=None, body=None, element_name=None, streamingResponseFile=None):
				...
				class _Overlay(_CommonAPIClass):
					...
					def Upload(self, Overlayname, Crc=None, body=None, element_name=None, streamingResponseFile=None):
					...
					#URL: users/{uid}/scannedinstances/{siid}/scans/{sid}/overlay
					def Multipartupload(self, Crc=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'crc': Crc}
						return self._REST('/users/' + str(self._get('Uid')) + '/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/overlay', 'POST', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Reports(_CommonAPIClass):
					...
					def Create(self, Nowarnings, Email, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'noWarnings': Nowarnings, 'email': Email}
						return self._REST('/users/' + str(self._get('Uid')) + '/scannedinstances/' + str(self._get('Siid')) + '/scans/' + str(self._get('Sid')) + '/reports', 'POST', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Images(_CommonAPIClass):
					...
					class _Downloads(_CommonAPIClass):
						...
						def Downloadnoauth(self, Downloadid, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'downloadId': Downloadid}
				...
				class _Packages(_CommonAPIClass):
					...
					def Get(self, Excludefiles=None, All=None, Fromrepo=None, Uploaded=None, Notselected=None, Comparewith=None, body=None, element_name=None, streamingResponseFile=None):
					...
					class _Bin(_CommonAPIClass):
						...
						def Get(self, Downloadtoken, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Orgs(_CommonAPIClass):
			...
			def Change(self, Admin, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'admin': Admin}
	...
	class _Galleries(_CommonAPIClass):
		...
		def Get(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/galleries/' + str(self._get('Gid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
		class _Templates(_CommonAPIClass):
			...
			def Delete(self, Force=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'force': Force}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/templates
			def Share(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/templates', 'POST', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/templates/{tid}
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/templates/{tid}
			def Update(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/templates
			def Get(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/templates', 'GET', body, element_name, streamingResponseFile, **kwargs)
			class _Status(_CommonAPIClass):
				def __init__(self, parent, **kwargs):
					self._parent = parent
					self.__dict__.update(kwargs)
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/status
				def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/status', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Stats(_CommonAPIClass):
				...
				def Get(self, Fromdate=None, Todate=None, body=None, element_name=None, streamingResponseFile=None):
					...
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/stats', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Osprofile(_CommonAPIClass):
				...
				class _Pkgs(_CommonAPIClass):
					...
					def Get(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/osprofile/' + str(self._get('Ospid')) + '/pkgs', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Notifications(_CommonAPIClass):
				...
				def Watch(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/notifications', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/notifications
				def Unwatch(self, User=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'user': User}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/notifications', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Comments(_CommonAPIClass):
				...
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments/' + str(self._get('Cid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/comments
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/comments
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/comments
				def Create(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/comments/{cid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments/' + str(self._get('Cid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/comments/{cid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments/' + str(self._get('Cid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				class _Abuses(_CommonAPIClass):
					...
					def Reportabuse(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments/' + str(self._get('Cid')) + '/abuses', 'POST', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Replies(_CommonAPIClass):
					...
					def Reply(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/comments/' + str(self._get('Cid')) + '/replies', 'POST', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Vote(_CommonAPIClass):
				...
				def Vote(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/vote', 'POST', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Oas(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/oas/' + str(self._get('Oaspkgid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Confmgmtplts(_CommonAPIClass):
				...
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/confmgmtplts', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Images(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/images
				def Getall(self, Format, Latest, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'format': Format, 'latest': Latest}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/images/{itid}
				def Regenerate(self, Force=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'force': Force}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/images
				def Generate(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/images/{itid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				class _Status(_CommonAPIClass):
					def __init__(self, parent, **kwargs):
						self._parent = parent
						self.__dict__.update(kwargs)
					...
					def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/status', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: galleries/{gid}/templates/{tid}/images/{itid}/status
					def Get(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Pimages(_CommonAPIClass):
					...
					def Publish(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages', 'POST', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: galleries/{gid}/templates/{tid}/images/{itid}/pimages/{pitid}
					def Get(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: galleries/{gid}/templates/{tid}/images/{itid}/pimages/{pitid}
					def Delete(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					class _Status(_CommonAPIClass):
						def __init__(self, parent, **kwargs):
							self._parent = parent
							self.__dict__.update(kwargs)
						...
						def Get(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
					...
					class _Cancel(_CommonAPIClass):
						...
						def Cancel(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/cancel', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
					...
					class _Instances(_CommonAPIClass):
						...
						def Get(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: galleries/{gid}/templates/{tid}/images/{itid}/pimages/{pitid}/instances/{riid}
						def Delete(self, Force=None, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {'force': Force}
							return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
						
						#URL: galleries/{gid}/templates/{tid}/images/{itid}/pimages/{pitid}/instances
						def Start(self, body=None, element_name=None, streamingResponseFile=None):
							kwargs = {}
							return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances', 'POST', body, element_name, streamingResponseFile, **kwargs)
						class _States(_CommonAPIClass):
							def __init__(self, parent, **kwargs):
								self._parent = parent
								self.__dict__.update(kwargs)
							...
							def Change(self, Action, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {'action': Action}
								return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '/states', 'PUT', body, element_name, streamingResponseFile, **kwargs)
						...
						class _Status(_CommonAPIClass):
							...
							def Get(self, body=None, element_name=None, streamingResponseFile=None):
								kwargs = {}
								return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pimages/' + str(self._get('Pitid')) + '/instances/' + str(self._get('Riid')) + '/status', 'GET', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Downloads(_CommonAPIClass):
					...
					def Download(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/downloads/' + str(self._get('Filename')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				...
				class _Pkgs(_CommonAPIClass):
					...
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/images/' + str(self._get('Itid')) + '/pkgs', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Logo(_CommonAPIClass):
				...
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/logo/' + str(self._get('Lid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/logo/{lid}/{logoFileName}
				def Upload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/logo/' + str(self._get('Lid')) + '/' + str(self._get('Logofilename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: galleries/{gid}/templates/{tid}/logo/{lid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/logo/' + str(self._get('Lid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Installprofile(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/installProfile', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Projects(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/galleries/' + str(self._get('Gid')) + '/templates/' + str(self._get('Tid')) + '/projects', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Partners(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/partners', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Groups(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/groups', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Publishers(_CommonAPIClass):
			...
			def Delete(self, User, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'user': User}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/publishers', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/publishers
			def Create(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/publishers', 'POST', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: galleries/{gid}/publishers
			def Get(self, User, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'user': User}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/publishers', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Notifications(_CommonAPIClass):
			...
			def Get(self, User=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'user': User}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/notifications', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Members(_CommonAPIClass):
			...
			def Get(self, User, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'user': User}
				return self._REST('/galleries/' + str(self._get('Gid')) + '/members', 'GET', body, element_name, streamingResponseFile, **kwargs)
	...
	class _Usergroups(_CommonAPIClass):
		...
		#URL: usergroups
		def Getall(self, Name, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {'name': Name}
		...
		#URL: usergroups
		def Create(self, Org, Publisher=None, Admin=None, Force=None, body=None, element_name=None, streamingResponseFile=None):
	...
	class _Uforge(_CommonAPIClass):
		...
		#URL: uforge/{uid}
		def Updatemachineid(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/uforge/' + str(self._get('Uid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: uforge
		def Register(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/uforge', 'POST', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: uforge/{uid}
		def Get(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/uforge/' + str(self._get('Uid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
		class _Lic(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/uforge/' + str(self._get('Uid')) + '/lic', 'GET', body, element_name, streamingResponseFile, **kwargs)
	...
	class _Orgs(_CommonAPIClass):
		...
		class _Logos(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/orgs/' + str(self._get('Oid')) + '/logos/' + str(self._get('Slogoid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Targetplatforms(_CommonAPIClass):
			...
			class _Targetformats(_CommonAPIClass):
				...
				def Removetargetformat(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
				...
				def Getalltargetformats(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
				...
				#URL: orgs/{oid}/targetplatforms/{tpid}/targetformats
				def Addtargetformat(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
		...
		class _Workspaces(_CommonAPIClass):
			...
			class _Memberships(_CommonAPIClass):
				...
				def Add(self, Pi, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'pi': Pi}
				...
				#URL: orgs/{oid}/workspaces/{wid}/memberships
				def Delete(self, Email=None, Login=None, body=None, element_name=None, streamingResponseFile=None):
			...
			class _Templates(_CommonAPIClass):
				...
				class _Confmgmtplts(_CommonAPIClass):
					...
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/orgs/' + str(self._get('Oid')) + '/workspaces/' + str(self._get('Wid')) + '/templates/' + str(self._get('Tid')) + '/confmgmtplts', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Subscriptions(_CommonAPIClass):
			...
			#URL: orgs/{oid}/subscriptions
			def Getall(self, Search, body=None, element_name=None, streamingResponseFile=None):
			...
			class _Targetplatforms(_CommonAPIClass):
				...
				def Orgsubscriptionprofiletargetplatformupdate(self, Allusers, body=None, element_name=None, streamingResponseFile=None):
			...
			class _Roles(_CommonAPIClass):
				...
				def Update(self, Allusers, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'allusers': Allusers}
			...
			class _Targetformats(_CommonAPIClass):
				...
				def Orgsubscriptionprofiletargetformatupdate(self, Allusers, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'allusers': Allusers}
		...
		class _Stats(_CommonAPIClass):
			...
			#URL: orgs/{oid}/stats
			def Get(self, Type, Filter, Fromdate, Todate, Graphtype, Periodicity, Nb, Order, Groupby, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Distributions(_CommonAPIClass):
			...
			#URL: orgs/{oid}/distributions
			def Createdistribution(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
			...
			class _Goldens(_CommonAPIClass):
				...
				def Create(self, Language, Edition, Type, Goldendate, Filename, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Categories(_CommonAPIClass):
			...
			#URL: orgs/{oid}/categories
			def Delete(self, Id, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'id': Id}
			...
			class _Subcategories(_CommonAPIClass):
				...
				def Createchild(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
	...
	class _Oas(_CommonAPIClass):
		...
		def Register(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/oas', 'POST', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: oas/{uid}
		def Update(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/oas/' + str(self._get('Uid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: oas/{uid}
		def Get(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/oas/' + str(self._get('Uid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
		class _Lic(_CommonAPIClass):
			def __init__(self, parent, **kwargs):
				self._parent = parent
				self.__dict__.update(kwargs)
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/oas/' + str(self._get('Uid')) + '/lic', 'GET', body, element_name, streamingResponseFile, **kwargs)
	...
	class _Distributions(_CommonAPIClass):
		...
		def Deletedistribution(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/distributions/' + str(self._get('Id')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
		...
		def Create(self, Flavor, Isactive, Isdefault, Arch=None, body=None, element_name=None, streamingResponseFile=None):
		...
		#URL: distributions/{id}
		def Updatedistribution(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
		...
		class _Profiles(_CommonAPIClass):
			...
			#URL: distributions/{id}/profiles
			def Create(self, Basedon, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Pkgs(_CommonAPIClass):
			...
			class _Updateinfo(_CommonAPIClass):
				...
				def Getupdateinfo(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
		...
		class _Changeactivestatus(_CommonAPIClass):
			...
			def Changedistributionactivestatus(self, Active, body=None, element_name=None, streamingResponseFile=None):
		...
		class _Services(_CommonAPIClass):
			...
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/distributions/' + str(self._get('Id')) + '/services/' + str(self._get('Dsid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: distributions/{id}/services
			def Getall(self, Name=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'name': Name}
				return self._REST('/distributions/' + str(self._get('Id')) + '/services', 'GET', body, element_name, streamingResponseFile, **kwargs)
			class _Pkgs(_CommonAPIClass):
				def __init__(self, parent, **kwargs):
					self._parent = parent
					self.__dict__.update(kwargs)
				...
				def Getall(self, To, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'to': To}
					return self._REST('/distributions/' + str(self._get('Id')) + '/services/' + str(self._get('Dsid')) + '/pkgs', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Projects(_CommonAPIClass):
			...
			class _Licenses(_CommonAPIClass):
				...
				def Multipartupload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Projectlid')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{projectlid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Projectlid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{projectlid}/{fileName}
				def Upload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Projectlid')) + '/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{projectlid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Projectlid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Pkgs(_CommonAPIClass):
				...
				class _Bin(_CommonAPIClass):
					...
					def Downloadfilename(self, Downloadid, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/{mspackid}/bin/{fileName}', 'GET', body, element_name, streamingResponseFile, **kwargs)
	...
	class _CloudProviders(_CommonAPIClass):
		...
		#URL: cloud-providers
		def Setcloudproviders(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/cloud-providers', 'POST', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: cloud-providers/{provider}
		def Deletecloudprovider(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/cloud-providers/' + str(self._get('Provider')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: cloud-providers
		def Deletecloudproviders(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
			return self._REST('/cloud-providers', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
		
		#URL: cloud-providers/{provider}
		def Getcloudproviders(self, body=None, element_name=None, streamingResponseFile=None):
			kwargs = {}
		...
		class _Birs(_CommonAPIClass):
			...
			def Getrepository(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
			...
			def Deleterepositories(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/cloud-providers/' + str(self._get('Provider')) + '/birs', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: cloud-providers/{provider}/birs/{bir}
			def Deleterepository(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
			...
			#URL: cloud-providers/{provider}/birs
			def Getrepositorybycloudprovider(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset}
				return self._REST('/cloud-providers/' + str(self._get('Provider')) + '/birs', 'GET', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: cloud-providers/{provider}/birs
			def Setrepositories(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}

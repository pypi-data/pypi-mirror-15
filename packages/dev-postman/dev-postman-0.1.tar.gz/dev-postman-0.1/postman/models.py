...
from archivevalley.models import UserProfile
...
class Message(models.Model):
    ...
    RESPONSE_CHOICES = (('YES','Yes, I have it'),
        ('NO', "No, I don't have it"))

    subject = models.CharField(_("subject"), max_length=SUBJECT_MAX_LENGTH)
    body = models.TextField(_("body"), blank=True, null=True)
    yes_no = models.CharField(choices=RESPONSE_CHOICES, default='YES', max_length=20, null=True)

...
class BaseWriteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'subject': forms.TextInput(attrs={'placeholder': "hello"}),
            'body': forms.Textarea(attrs={'cols': WRAP_WIDTH, 'rows': '10', 'placeholder': "Write a few words about the project, the mission, ..."}),
            'yes_no': forms.RadioSelect(),
...
class WriteForm(BaseWriteForm):
    ...
    class Meta(BaseWriteForm.Meta):
        fields = ('recipients', 'subject', 'body', 'yes_no')
...
class FullReplyForm(BaseReplyForm):
    ...
    class Meta(BaseReplyForm.Meta):
        fields = (['recipients'] if allow_copies else []) + ['subject', 'body', 'yes_no']
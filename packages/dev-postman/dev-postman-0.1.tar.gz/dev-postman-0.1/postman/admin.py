...
class MessageAdmin(admin.ModelAdmin):
    ...
    search_fields = ('subject', 'body', 'yes_no')
    date_hierarchy = 'sent_at'
    list_display = ('subject', 'admin_sender', 'admin_recipient', 'sent_at', 'moderation_status', 'yes_no')
    #actions = [export_as_csv_action("Export selected User Records as CSV file", fields=['body'] , header=False),]
...
class PendingMessageAdmin(MessageAdmin):
    ...
    date_hierarchy = None
    actions = None
    list_display = ('subject', 'admin_sender', 'admin_recipient', 'sent_at', 'yes_no')
    list_filter = ()
    fieldsets = (
        (None, {'fields': (

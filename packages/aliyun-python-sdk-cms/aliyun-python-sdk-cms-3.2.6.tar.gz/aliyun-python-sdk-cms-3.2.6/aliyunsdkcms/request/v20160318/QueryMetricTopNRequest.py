...
class QueryMetricTopNRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cms', '2016-03-18', 'QueryMetricTopN')
	...
	def get_ValueKey(self):
		return self.get_query_params().get('ValueKey')

	def set_ValueKey(self,ValueKey):
		self.add_query_param('ValueKey',ValueKey)

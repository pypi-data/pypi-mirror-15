...
TerminalDiffRender = _hx_classes.registerClass("TerminalDiffRender", fields=["codes","t","csv","v","align_columns","wide_columns","use_glyphs","flags"], methods=["alignColumns","render","getText","pickSizes"])(TerminalDiffRender)

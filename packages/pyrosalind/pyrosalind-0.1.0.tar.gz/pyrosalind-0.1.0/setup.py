...
# import the data inside pyrosalind/info.py file, without trigger the
...
setup(
    ...
    description = "Parse information found on the http://rosalind.info website",
    long_description = open(path_to('README.mkd')).read(),
    keywords = "graph",
    url = "https://github.com/Aluriak/pyrosalind",

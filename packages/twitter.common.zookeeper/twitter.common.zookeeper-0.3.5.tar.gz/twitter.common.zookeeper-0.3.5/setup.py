...
# Target: PythonLibrary(BuildFileAddress(FilesystemBuildFile(/Users/atollenaere/workspace/commons/src/python/twitter/common/zookeeper/BUILD), zookeeper))
...
{   'description': "Implementations of Twitter's service discovery libraries on top of Kazoo.",
    ...
    'install_requires': [   'kazoo==2.2.1',
                            ...
                            'twitter.common.concurrent==0.3.5',
                            'twitter.common.lang==0.3.5',
                            'twitter.common.service-thrift==0.3.5',
                            'thrift',

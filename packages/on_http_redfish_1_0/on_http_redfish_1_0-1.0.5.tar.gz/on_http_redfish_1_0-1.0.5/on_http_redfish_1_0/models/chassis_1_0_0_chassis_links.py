...
class Chassis100ChassisLinks(object):
    ...
    def __init__(self):
        ...
        self.swagger_types = {
            ...
            'managed_by': 'list[Odata400IdRef]',
            'powered_byodata_navigation_link': 'Odata400IdRef',
            'contained_by': 'Odata400IdRef',
            'powered_byodata_count': 'float',
            'cooled_by': 'list[Odata400IdRef]',
            'managed_byodata_count': 'float',
            'computer_systemsodata_count': 'float',
            'contains': 'list[Odata400IdRef]',
            'powered_by': 'list[Odata400IdRef]',
            'cooled_byodata_navigation_link': 'Odata400IdRef',
            'managed_byodata_navigation_link': 'Odata400IdRef',
            'computer_systems': 'list[Odata400IdRef]',
            'containsodata_count': 'float',
            'cooled_byodata_count': 'float',
            'oem': 'ResourceOem',

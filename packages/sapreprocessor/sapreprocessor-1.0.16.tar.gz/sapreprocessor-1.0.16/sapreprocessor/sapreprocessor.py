...
if __name__=='__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Parses tweets from command line')
    parser.add_argument('-t', '--tweet', 
                        help="The tweet that we want to clean",
                        type=unicode, default= u"empty")

    args = parser.parse_args()

    tweet=unicode(args.tweet)

...
from pkg_resources import import resource_string
...
class Preprocessor:
    def __init__(self, emojis_lexicon_path=EMOJIS_LEXICON_PATH, smileys_lexicon_path=SMILEYS_LEXICON_PATH,
                 stopwords_path=STOPWORDS_PATH, prefixs_path=PREFIXS_PATH, feature_count=FEATURE_COUNT):
        print(os.getcwd())

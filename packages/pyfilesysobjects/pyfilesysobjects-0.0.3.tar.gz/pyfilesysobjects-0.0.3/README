...
* Sourceforge.net: https://sourceforge.net/projects/filesysobjetcs/files/
...
* Github: https://github.com/ArnoCan/filesysobjects/

**Online documentation**:

* https://pypi.python.org/pypi/filesysobjects/
* https://pythonhosted.org/filesysobjects/

...
class TGBotWSGI:
    ...
    def __init__(self,commandclasses,conversationclasses=None,inlineclasses=None,redis_limitserver=0,redis_convserver=1,configfile="basicconfig.ini",configpath="tgbot.resources.config",wartungsmodus=False,database:Database=None,loggerLevel=logging.INFO,conversation=None):
    ...
    def application(self,environ, start_response):
        ...
        if request_body_size != 0:
            ...
            activatebot(obj,self.wartungsmodus,self.commandclasses,self.conversationclasses,self.inlineclasses,self.conversation)
        self.database.close()
        return b''

...
class DocumentsApi(object):
    ...
    def get_document(self, id, **kwargs):
        ...
        :param str id: Id of document to get. (required)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_document" % key)
            params[key] = val
        del params['kwargs']

        resource_path = '/documents/{id}'.replace('{format}', 'json')
        method = 'GET'
        ...
        response = self.api_client.call_api(resource_path, method, path_params, query_params, header_params,
                                            ...
                                            response='Document', auth_settings=self.auth_settings)

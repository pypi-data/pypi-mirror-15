...
class EventsApi(object):
    ...
    def events(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method events" % key)
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, method, path_params, query_params, header_params,
                                            ...
                                            response='EventListResponse', auth_settings=self.auth_settings)
    ...
    def id(self, id, **kwargs):
        ...
        :param str id: ID of application event to get. (required)
        ...
        response = self.api_client.call_api(resource_path, method, path_params, query_params, header_params,
                                            body=body_params, post_params=form_params, files=files,
                                            response='ApplicationEvent', auth_settings=self.auth_settings)

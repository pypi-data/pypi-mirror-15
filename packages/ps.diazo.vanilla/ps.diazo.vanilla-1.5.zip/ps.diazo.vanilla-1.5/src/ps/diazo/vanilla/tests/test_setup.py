# -*- coding: utf-8 -*-
"""Test Setup of ps.diazo.vanilla."""
...
CSS = [
    '++resource++ps.diazo.vanilla/main.css',
]

JS = [
    '++resource++ps.diazo.vanilla/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.diazo.vanilla."""

    layer = testing.PS_DIAZO_VANILLA_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('ICustomTheme', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('IPsDiazoVanillaLayer', layers)

...
rem call ..\bin\otc elb describe-load-balancers --load-balancer-name myelb
rem call ..\bin\otc elb create-load-balancers --load-balancer-name myelb2 --vpc-name myvpc
rem call ..\bin\otc elb delete-load-balancers --load-balancer-name myelb2

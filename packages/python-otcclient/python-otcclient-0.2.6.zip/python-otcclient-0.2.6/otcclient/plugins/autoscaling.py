...
class autoscaling(otcpluginbase):
    ...
    def describe_auto_scaling_groups():
        ...
        autoscaling.otcOutputHandler().print_output(ret, mainkey="scaling_groups", listkey={"scaling_group_name", "scaling_group_id", "networks", "scaling_group_status", "scaling_configuration_id", "scaling_configuration_name", "current_instance_number", "desire_instance_number","min_instance_number","max_instance_number","cool_down_time","lb_listener_id","security_groups","create_time","instance_terminate_policy","is_scaling"})
        return ret
    ...
    def describe_auto_scaling_configuration():
        ...
        ret = utils_http.get(url)
        autoscaling.otcOutputHandler().print_output(ret, mainkey="scaling_configurations", listkey={"scaling_configuration_name", "scaling_configuration_id", "create_time", "instance_config"})
        return ret

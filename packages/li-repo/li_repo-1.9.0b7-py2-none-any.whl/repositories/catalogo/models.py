...
def send_notification(sender, instance, created, *args, **kwargs):
    ...
    # notification_fields = [
    #     'id','id_externo','nome','apelido','descricao','descricao_completa','url_video_youtube','modelo','sku','ncm', 
    #     'gtin','ativo','removido','data_criacao','data_modificacao','peso','altura','largura','profundidade','template','tipo', 
    #     'bloqueado','usado','destaque'
    # ]
    ...
    json_dict = serializers.serialize("json", Produto.objects.filter(pk=instance.pk))[0]

    crud = "create" if created else "update"

...
#     STATUS_DRAFT = 'draft'
#     STATUS = [
#         (STATUS_PUBLISHED, u'Publicado'),
#         (STATUS_DRAFT, u'Rascunho'),
#     ]
#
#     id = models.AutoField(db_column="blog_post_id", primary_key=True)
#     title = models.TextField(db_column="blog_post_title", null=False)
#     slug = models.SlugField(db_column="blog_post_slug", max_length=512, null=False)
#     image = models.TextField(db_column="blog_post_image_path", null=True, blank=True)
#     content = models.TextField(db_column="blog_post_content")
#     status = models.TextField(db_column="blog_post_status", choices=STATUS, default=STATUS_DRAFT)
#
#     created_at = models.DateTimeField(db_column="blog_post_created_at", auto_now_add=True)
#     modified_at = models.DateTimeField(db_column="blog_post_modified_at", auto_now=True)
#     published_at = models.DateTimeField(db_column="blog_post_published_at", null=True)
#
#     categories = models.ManyToManyField('plataforma.BlogCategory', through='plataforma.BlogPostCategory', related_name='blog_posts')
#     store = models.ForeignKey('plataforma.Conta', db_column='conta_id', related_name='blog_posts', on_delete=models.CASCADE)
#     contract = models.ForeignKey('plataforma.Contrato', db_column='contrato_id', related_name='blog_posts', on_delete=models.CASCADE)
#
#     class Meta:
#         db_table = u"plataforma\".\"tb_blog_post"
...
#     id = models.AutoField(db_column="blog_category_id", primary_key=True)
#     title = models.TextField(db_column="blog_category_title", null=False)
#     slug = models.SlugField(db_column="blog_category_slug", max_length=512, null=False)
#
#     created_at = models.DateTimeField(db_column="blog_post_created_at", auto_now_add=True)
#     modified_at = models.DateTimeField(db_column="blog_post_modified_at", auto_now=True)
#     published_at = models.DateTimeField(db_column="blog_post_published_at", null=True)
#
#     store = models.ForeignKey('plataforma.Conta', db_column='conta_id', related_name='blog_categories', on_delete=models.CASCADE)
#     contract = models.ForeignKey('plataforma.Contrato', db_column='contrato_id', related_name='blog_categories', on_delete=models.CASCADE)
#
#     class Meta:
#         db_table = u"plataforma\".\"tb_blog_category"
#         verbose_name = u"Blog category"
#         verbose_name_plural = u"Blog categories"
#
#     def __unicode__(self):
#         return self.title
#
...
#     id = models.AutoField(db_column="blog_post_category_id", primary_key=True)
#     post = models.ForeignKey('plataforma.BlogPost', on_delete=models.CASCADE)
#     category = models.ForeignKey('plataforma.BlogCategory', on_delete=models.CASCADE)
#
#     store = models.ForeignKey('plataforma.Conta', db_column='conta_id', related_name='blog_posts_categories', on_delete=models.CASCADE)
#     contract = models.ForeignKey('plataforma.Contrato', db_column='contrato_id', related_name='blog_posts_categories', on_delete=models.CASCADE)
#
#     class Meta:
#         db_table = u"plataforma\".\"tb_blog_post_category"
#         verbose_name = u"Blog post category relation"
#         verbose_name_plural = u"Blog posts categories relation"

...
class DebugScannerView(ScannerView):
    def create_ui(self):
        super(DebugScannerView, self).create_ui()
    ...
    ###########################################################################
    # Callback methods
    def on_button_scan__clicked(self, button):
        self.enable_scan()
    ...
    # Mutator methods
    def disable_scan(self):
        super(DebugScannerView, self).disable_scan()
        self.button_scan.set_sensitive(True)

    def enable_scan(self):
        super(DebugScannerView, self).enable_scan()

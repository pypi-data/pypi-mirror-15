...
Documentation is on `Read the Docs <https://coverage.readthedocs.io/en/coverage-4.1b3>`_.
...
See the `quick start <https://coverage.readthedocs.io/en/coverage-4.1b3/#quick-start>`_
section of the docs.
...
.. |docs| image:: https://readthedocs.org/projects/coverage/badge/?version=latest&style=flat
    :target: https://coverage.readthedocs.io/en/coverage-4.1b3
    :alt: Documentation

...
from murdock.misc import (
    int_ge_zero, int_gt_zero, float_ge_zero, float_gt_zero)
import murdock.search


log = logging.getLogger('search.ps')
    ...
    def _update_video(self):
        ...
        if (search.intvideo is not None and
            ...
            if self is self.swarm.best_part:
                ...
                radius = 1.0
            i_obj = 0
            for tf, p in self.best_state.iteritems():
...
class ConfigDeclaration(murdock.config.ConfigDeclaration):
    ...
    def parameters(self):
        ...
        opt.append(Option(
            name='p', dtype=float_ge_zero, required=False,
        ...
        opt.append(Option(
            ...
            'linear gradient given as [start, end]'))
        opt.append(Option(
            name='g', dtype=float_ge_zero, required=False,
        ...
        opt.append(Option(
            ...
            'linear gradient given as [start, end]'))
        opt.append(Option(
            name='videoframe_interval', dtype=int_ge_zero,

...
class CombinedPlots(AbstractPlot):
    ...
    def plot(self, genome_scaffold_stats,
        ...
        if len(genome_stats.mean_coverage) >= 1:
            ...
            axes_gc_dist = self.fig.add_subplot(221)
            axes_tetra_pc1_pc2 = self.fig.add_subplot(222)
            axes_tetra_dist = self.fig.add_subplot(223)
            axes_tetra_pc1_pc3 = self.fig.add_subplot(224)

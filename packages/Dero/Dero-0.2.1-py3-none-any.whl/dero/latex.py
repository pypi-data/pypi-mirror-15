...
def latex_equations_to_pdf(latex_str, directory, name='Equations', font_size=22, title=None, para_space='1em'):
    headers = [r'\documentclass[12 pt]{{article}}', 
               r'\DeclareMathSizes{12}{18}{12}{10}', r'\usepackage{amsmath}',
    ...
    with open(file_path, 'w') as f:
        f.write('\n'.join(headers) + '\n')
        [f.write('${}$\n\n'.format(line)) for line in latex_str]
        f.write('\n'.join(footers))

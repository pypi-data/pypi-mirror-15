...
*Slack*
    ...
    + slack.get_history(self, count, latest, oldest, unread)
    + slack.listen(self, interval, callback)
    + slack.post_message(self, message)
    + slack.set_channel(self, channel_name)
    + slack.set_icon(self, url)

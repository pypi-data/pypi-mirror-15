...
def main():
    ...
    if tool_name == 'BuildBamIndex':
        ...
        bam_path = pipe_util.get_param(args, 'bam_path')[0]
        picard_markduplicates.bam_markduplicates(uuid, bam_path, input_state, engine, logger, be_lenient)
    elif tool_name == 'MarkDuplicatesWithMateCigar':
        bam_path = pipe_util.get_param(args, 'bam_path')[0]
        picard_markduplicates.bam_markduplicateswithmatecigar(uuid, bam_path, input_state, engine, logger, be_lenient)

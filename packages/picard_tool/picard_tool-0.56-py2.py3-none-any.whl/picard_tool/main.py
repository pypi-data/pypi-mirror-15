...
def main():
    ...
    if tool_name == 'BuildBamIndex':
        ...
        bam_path = pipe_util.get_param(args, 'bam_path')[0]
        reference_fasta_path = pipe_util.get_param(args, 'reference_fasta_path')
        bam_stats.do_picard_metrics(uuid, bam_path, reference_fasta_path, engine, logger, 'CollectAlignmentSummaryMetrics')
        ...
        bam_path = pipe_util.get_param(args, 'bam_path')[0]
        reference_fasta_path = pipe_util.get_param(args, 'reference_fasta_path')
        bam_stats.do_picard_metrics(uuid, bam_path, reference_fasta_path, engine, logger, 'CollectWgsMetrics')

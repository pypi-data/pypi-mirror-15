...
/* #########################################################################
 * [2016-05-10 09:29:39.509000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
static const int CMD_STATE_OF_CHANNELS = 0x703;
static const int CMD_SET_STATE_OF_CHANNELS = 0x704;
static const int CMD_ON_STATE_FREQUENCY_CHANGED = 0x705;
static const int CMD__SET_VOLTAGE = 0x706;
static const int CMD_ON_STATE_VOLTAGE_CHANGED = 0x707;
static const int CMD_ON_STATE_HV_OUTPUT_ENABLED_CHANGED = 0x708;
static const int CMD_ON_STATE_HV_OUTPUT_SELECTED_CHANGED = 0x709;
static const int CMD_ON_STATE_MAGNET_ENGAGED_CHANGED = 0x70a;
static const int CMD_ON_CONFIG_LIGHT_INTENSITY_CHANGED = 0x70b;
static const int CMD_ON_STATE_LIGHT_ENABLED_CHANGED = 0x70c;
static const int CMD_MAGNET_ENGAGED = 0x70d;
static const int CMD__INITIALIZE_SWITCHING_BOARDS = 0x70e;
static const int CMD__MAGNET_ENGAGE = 0x70f;
static const int CMD__MAGNET_DISENGAGE = 0x710;
static const int CMD_TEST = 0x711;
static const int CMD_DMA_TCD = 0x712;
static const int CMD_DMA_START = 0x713;
static const int CMD_DMA_STOP = 0x714;
static const int CMD_DMA_READ = 0x715;
static const int CMD_DMA_FULL = 0x716;
static const int CMD_DMA_EMPTY = 0x717;
static const int CMD_ADC_BUFFER = 0x718;
static const int CMD_SETREFERENCE = 0x719;
static const int CMD_ON_TICK = 0x71a;
static const int CMD_V__SYST_CVR = 0x71b;
static const int CMD_V__SCB_ICSR = 0x71c;
static const int CMD_D__F_CPU = 0x71d;
static const int CMD_D__F_BUS = 0x71e;
static const int CMD_ON_ADC_DONE = 0x71f;
static const int CMD_ADC_TIMESTAMP_US = 0x720;
static const int CMD_COMPUTE_TIMESTAMP_US = 0x721;
static const int CMD_ADC_PERIOD_US = 0x722;
static const int CMD_SETRESOLUTION = 0x723;
static const int CMD_GETRESOLUTION = 0x724;
static const int CMD_GETMAXVALUE = 0x725;
static const int CMD_SETCONVERSIONSPEED = 0x726;
static const int CMD_SETSAMPLINGSPEED = 0x727;
static const int CMD_BENCHMARK_FLOPS = 0x728;
static const int CMD_BENCHMARK_IOPS = 0x729;
static const int CMD_SETAVERAGING = 0x72a;
static const int CMD_ENABLEINTERRUPTS = 0x72b;
static const int CMD_DISABLEINTERRUPTS = 0x72c;
static const int CMD_ENABLEDMA = 0x72d;
static const int CMD_DISABLEDMA = 0x72e;
static const int CMD_ENABLECOMPARE = 0x72f;
static const int CMD_ENABLECOMPARERANGE = 0x730;
static const int CMD_DISABLECOMPARE = 0x731;
static const int CMD_ENABLEPGA = 0x732;
static const int CMD_GETPGA = 0x733;
static const int CMD_DISABLEPGA = 0x734;
static const int CMD_ISCONVERTING = 0x735;
static const int CMD_ISCOMPLETE = 0x736;
static const int CMD_ISDIFFERENTIAL = 0x737;
static const int CMD_ISCONTINUOUS = 0x738;
static const int CMD_ANALOGREAD = 0x739;
static const int CMD_ANALOGREADDIFFERENTIAL = 0x73a;
static const int CMD_STARTSINGLEREAD = 0x73b;
static const int CMD_STARTSINGLEDIFFERENTIAL = 0x73c;
static const int CMD_READSINGLE = 0x73d;
static const int CMD_STARTCONTINUOUS = 0x73e;
static const int CMD_STARTCONTINUOUSDIFFERENTIAL = 0x73f;
static const int CMD_ANALOGREADCONTINUOUS = 0x740;
static const int CMD_STOPCONTINUOUS = 0x741;
static const int CMD_ANALOGSYNCHRONIZEDREAD = 0x742;
static const int CMD_ANALOG_INPUT_TO_DIGITAL_PIN = 0x743;
static const int CMD_DIGITAL_PIN_HAS_PWM = 0x744;
static const int CMD_DIGITAL_PIN_TO_INTERRUPT = 0x745;
static const int CMD_READ_ADC_REGISTERS = 0x746;
static const int CMD_UPDATE_ADC_REGISTERS = 0x747;
static const int CMD_READ_PIT_REGISTERS = 0x748;
static const int CMD_UPDATE_PIT_REGISTERS = 0x749;
static const int CMD_READ_PIT_TIMER_CONFIG = 0x74a;
static const int CMD_UPDATE_PIT_TIMER_CONFIG = 0x74b;
static const int CMD_DMA_CHANNEL_COUNT = 0x74c;
static const int CMD_READ_DMA_TCD = 0x74d;
static const int CMD_RESET_DMA_TCD = 0x74e;
static const int CMD_UPDATE_DMA_TCD = 0x74f;
static const int CMD_READ_DMA_PRIORITY = 0x750;
static const int CMD_READ_DMA_REGISTERS = 0x751;
static const int CMD_UPDATE_DMA_REGISTERS = 0x752;
static const int CMD_READ_DMA_MUX_CHCFG = 0x753;
static const int CMD_UPDATE_DMA_MUX_CHCFG = 0x754;
static const int CMD_CLEAR_DMA_ERRORS = 0x755;
static const int CMD_READ_SIM_SCGC6 = 0x756;
static const int CMD_READ_SIM_SCGC7 = 0x757;
static const int CMD_UPDATE_SIM_SCGC6 = 0x758;
static const int CMD_UPDATE_SIM_SCGC7 = 0x759;
static const int CMD_FREE_ALL = 0x75a;
static const int CMD_MEM_ALLOC = 0x75b;
static const int CMD_MEM_FREE = 0x75c;
static const int CMD_MEM_ALIGNED_ALLOC = 0x75d;
static const int CMD_MEM_ALIGNED_FREE = 0x75e;
static const int CMD_MEM_ALIGNED_ALLOC_AND_SET = 0x75f;
static const int CMD_MEM_CPY_HOST_TO_DEVICE = 0x760;
static const int CMD_MEM_CPY_DEVICE_TO_HOST = 0x761;
static const int CMD_MEM_FILL_UINT8 = 0x762;
static const int CMD_MEM_FILL_UINT16 = 0x763;
static const int CMD_MEM_FILL_UINT32 = 0x764;
static const int CMD_MEM_FILL_FLOAT = 0x765;
static const int CMD_LOOP = 0x766;
static const int CMD_LAST_DMA_CHANNEL_DONE = 0x767;
static const int CMD_ATTACH_DMA_INTERRUPT = 0x768;
static const int CMD_DETACH_DMA_INTERRUPT = 0x769;

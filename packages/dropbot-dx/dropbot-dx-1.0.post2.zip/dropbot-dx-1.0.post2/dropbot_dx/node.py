...
# ############################################################################
# [2016-05-10 09:29:41.078000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
# ############################################################################
import types
import pandas as pd
import numpy as np
...
class Proxy(ProxyBase):
    ...
    _CMD_STATE_OF_CHANNELS = 0x703
    _CMD_SET_STATE_OF_CHANNELS = 0x704
    _CMD_ON_STATE_FREQUENCY_CHANGED = 0x705
    _CMD__SET_VOLTAGE = 0x706
    _CMD_ON_STATE_VOLTAGE_CHANGED = 0x707
    _CMD_ON_STATE_HV_OUTPUT_ENABLED_CHANGED = 0x708
    _CMD_ON_STATE_HV_OUTPUT_SELECTED_CHANGED = 0x709
    _CMD_ON_STATE_MAGNET_ENGAGED_CHANGED = 0x70a
    _CMD_ON_CONFIG_LIGHT_INTENSITY_CHANGED = 0x70b
    _CMD_ON_STATE_LIGHT_ENABLED_CHANGED = 0x70c
    _CMD_MAGNET_ENGAGED = 0x70d
    _CMD__INITIALIZE_SWITCHING_BOARDS = 0x70e
    _CMD__MAGNET_ENGAGE = 0x70f
    _CMD__MAGNET_DISENGAGE = 0x710
    _CMD_TEST = 0x711
    _CMD_DMA_TCD = 0x712
    _CMD_DMA_START = 0x713
    _CMD_DMA_STOP = 0x714
    _CMD_DMA_READ = 0x715
    _CMD_DMA_FULL = 0x716
    _CMD_DMA_EMPTY = 0x717
    _CMD_ADC_BUFFER = 0x718
    _CMD_SETREFERENCE = 0x719
    _CMD_ON_TICK = 0x71a
    _CMD_V__SYST_CVR = 0x71b
    _CMD_V__SCB_ICSR = 0x71c
    _CMD_D__F_CPU = 0x71d
    _CMD_D__F_BUS = 0x71e
    _CMD_ON_ADC_DONE = 0x71f
    _CMD_ADC_TIMESTAMP_US = 0x720
    _CMD_COMPUTE_TIMESTAMP_US = 0x721
    _CMD_ADC_PERIOD_US = 0x722
    _CMD_SETRESOLUTION = 0x723
    _CMD_GETRESOLUTION = 0x724
    _CMD_GETMAXVALUE = 0x725
    _CMD_SETCONVERSIONSPEED = 0x726
    _CMD_SETSAMPLINGSPEED = 0x727
    _CMD_BENCHMARK_FLOPS = 0x728
    _CMD_BENCHMARK_IOPS = 0x729
    _CMD_SETAVERAGING = 0x72a
    _CMD_ENABLEINTERRUPTS = 0x72b
    _CMD_DISABLEINTERRUPTS = 0x72c
    _CMD_ENABLEDMA = 0x72d
    _CMD_DISABLEDMA = 0x72e
    _CMD_ENABLECOMPARE = 0x72f
    _CMD_ENABLECOMPARERANGE = 0x730
    _CMD_DISABLECOMPARE = 0x731
    _CMD_ENABLEPGA = 0x732
    _CMD_GETPGA = 0x733
    _CMD_DISABLEPGA = 0x734
    _CMD_ISCONVERTING = 0x735
    _CMD_ISCOMPLETE = 0x736
    _CMD_ISDIFFERENTIAL = 0x737
    _CMD_ISCONTINUOUS = 0x738
    _CMD_ANALOGREAD = 0x739
    _CMD_ANALOGREADDIFFERENTIAL = 0x73a
    _CMD_STARTSINGLEREAD = 0x73b
    _CMD_STARTSINGLEDIFFERENTIAL = 0x73c
    _CMD_READSINGLE = 0x73d
    _CMD_STARTCONTINUOUS = 0x73e
    _CMD_STARTCONTINUOUSDIFFERENTIAL = 0x73f
    _CMD_ANALOGREADCONTINUOUS = 0x740
    _CMD_STOPCONTINUOUS = 0x741
    _CMD_ANALOGSYNCHRONIZEDREAD = 0x742
    _CMD_ANALOG_INPUT_TO_DIGITAL_PIN = 0x743
    _CMD_DIGITAL_PIN_HAS_PWM = 0x744
    _CMD_DIGITAL_PIN_TO_INTERRUPT = 0x745
    _CMD_READ_ADC_REGISTERS = 0x746
    _CMD_UPDATE_ADC_REGISTERS = 0x747
    _CMD_READ_PIT_REGISTERS = 0x748
    _CMD_UPDATE_PIT_REGISTERS = 0x749
    _CMD_READ_PIT_TIMER_CONFIG = 0x74a
    _CMD_UPDATE_PIT_TIMER_CONFIG = 0x74b
    _CMD_DMA_CHANNEL_COUNT = 0x74c
    _CMD_READ_DMA_TCD = 0x74d
    _CMD_RESET_DMA_TCD = 0x74e
    _CMD_UPDATE_DMA_TCD = 0x74f
    _CMD_READ_DMA_PRIORITY = 0x750
    _CMD_READ_DMA_REGISTERS = 0x751
    _CMD_UPDATE_DMA_REGISTERS = 0x752
    _CMD_READ_DMA_MUX_CHCFG = 0x753
    _CMD_UPDATE_DMA_MUX_CHCFG = 0x754
    _CMD_CLEAR_DMA_ERRORS = 0x755
    _CMD_READ_SIM_SCGC6 = 0x756
    _CMD_READ_SIM_SCGC7 = 0x757
    _CMD_UPDATE_SIM_SCGC6 = 0x758
    _CMD_UPDATE_SIM_SCGC7 = 0x759
    _CMD_FREE_ALL = 0x75a
    _CMD_MEM_ALLOC = 0x75b
    _CMD_MEM_FREE = 0x75c
    _CMD_MEM_ALIGNED_ALLOC = 0x75d
    _CMD_MEM_ALIGNED_FREE = 0x75e
    _CMD_MEM_ALIGNED_ALLOC_AND_SET = 0x75f
    _CMD_MEM_CPY_HOST_TO_DEVICE = 0x760
    _CMD_MEM_CPY_DEVICE_TO_HOST = 0x761
    _CMD_MEM_FILL_UINT8 = 0x762
    _CMD_MEM_FILL_UINT16 = 0x763
    _CMD_MEM_FILL_UINT32 = 0x764
    _CMD_MEM_FILL_FLOAT = 0x765
    _CMD_LOOP = 0x766
    _CMD_LAST_DMA_CHANNEL_DONE = 0x767
    _CMD_ATTACH_DMA_INTERRUPT = 0x768
    _CMD_DETACH_DMA_INTERRUPT = 0x769
    MAX_COMMAND_CODE = 1897

...
/* #########################################################################
 * [2016-05-05 13:25:55.135000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
public:
  ...
  UInt8Array process_command(UInt8Array request_arr, UInt8Array buffer) {
    ...
    switch (command) {
        ...
        case CMD_MIN_WAVEFORM_FREQUENCY:
          {
            /* Cast buffer as request. */
    
    
            MinWaveformFrequencyResponse response;

            response.result =
            obj_.min_waveform_frequency();
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            MinWaveformFrequencyResponse &output = *(reinterpret_cast
                                                 <MinWaveformFrequencyResponse *>
                                                 (&buffer.data[0]));
            output = response;
            result.data = buffer.data;
            result.length = sizeof(output);
        ...
        case CMD_MAX_WAVEFORM_FREQUENCY:
          {
            /* Cast buffer as request. */
    
    
            MaxWaveformFrequencyResponse response;

            response.result =
            obj_.max_waveform_frequency();
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            MaxWaveformFrequencyResponse &output = *(reinterpret_cast
                                                 <MaxWaveformFrequencyResponse *>
                                                 (&buffer.data[0]));
            output = response;
            result.data = buffer.data;
            result.length = sizeof(output);
        ...
        case CMD_MAX_WAVEFORM_VOLTAGE:
          {
            /* Cast buffer as request. */
    
    
            MaxWaveformVoltageResponse response;

            response.result =
            obj_.max_waveform_voltage();
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            MaxWaveformVoltageResponse &output = *(reinterpret_cast
                                                 <MaxWaveformVoltageResponse *>
                                                 (&buffer.data[0]));
            output = response;
            result.data = buffer.data;
            result.length = sizeof(output);

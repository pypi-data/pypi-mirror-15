...
# ############################################################################
# [2016-05-05 13:25:58.114000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
# ############################################################################
import types
import pandas as pd
import numpy as np
...
class Proxy(ProxyBase):
    ...
    _CMD_MIN_WAVEFORM_FREQUENCY = 0x703
    _CMD_MAX_WAVEFORM_FREQUENCY = 0x704
    _CMD_MAX_WAVEFORM_VOLTAGE = 0x705
    _CMD_STATE_OF_CHANNELS = 0x706
    _CMD_SET_STATE_OF_CHANNELS = 0x707
    _CMD_ON_STATE_FREQUENCY_CHANGED = 0x708
    ...
    def min_waveform_frequency(self):
        command = np.dtype('uint16').type(self._CMD_MIN_WAVEFORM_FREQUENCY)
        payload_size = 0
        payload_data = ''
    ...
    def max_waveform_frequency(self):
        command = np.dtype('uint16').type(self._CMD_MAX_WAVEFORM_FREQUENCY)
        payload_size = 0
        payload_data = ''
    ...
    def max_waveform_voltage(self):
        command = np.dtype('uint16').type(self._CMD_MAX_WAVEFORM_VOLTAGE)
        payload_size = 0
        payload_data = ''

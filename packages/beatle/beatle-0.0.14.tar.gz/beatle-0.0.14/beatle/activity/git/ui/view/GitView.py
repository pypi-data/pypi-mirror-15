...
class GitView(BaseView, ui.GitView):
    ...
    @tran.TransactionalMethod('new git repo {}')
    ...
    @tran.TransactionalMethod('add git repo {}')
    ...
    @tran.TransactionalMethod('add remote repo {}')
    ...
    def OnDelete(self, event):
        ...
        obj = self.selected
        aliasMap = {
            model.git.GitRepo: "git repository {}",
            model.git.GitFile: "git file {}",
            model.git.GitDir: "git dir {}",
            model.git.GitRemote: "git remote {}"}

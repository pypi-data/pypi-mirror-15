"""Subclass of PyMethodPane, which is generated by wxFormBuilder."""
...
# Implementing PyMethodPane
class PyMethodPane(ui.PyMethodPane):
    ...
    def __init__(self, parent, mainframe, method):
        ...
        super(PyMethodPane, self).__init__(parent)
    ...
    def Commit(self):
        ...
        k = o.inner_module or o.inner_package
        if k:
    ...
    #def AutoIdent(self, event):
    #    """Handle enter"""
    #    key = event.GetKeyCode()
    #    wnd = self.m_editor
    #    if key == wx.WXK_NUMPAD_ENTER or key == wx.WXK_RETURN:
    #        if wnd.GetCharAt(wnd.GetCurrentPos() - 1) == 58:
    #            line = wnd.GetCurrentLine() + 1
    #            wnd.SetLineIndentation(line,
    #                wnd.GetLineIndentation(line) + wnd.GetTabWidth())
    #    event.Skip()

...
class NewMember ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_name = wx.TextCtrl( self, wx.ID_ANY, u"aaa", wx.DefaultPosition, wx.DefaultSize, 0|wx.SUNKEN_BORDER )
		...
		self.m_textCtrl8 = wx.TextCtrl( self, wx.ID_ANY, u"444", wx.DefaultPosition, wx.DefaultSize, 0 )

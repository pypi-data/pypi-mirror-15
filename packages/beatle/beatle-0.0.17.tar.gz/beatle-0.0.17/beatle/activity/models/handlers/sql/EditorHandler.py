...
class EditorHandler(EditorHandlerBase):
    ...
    style_items = [
            (STC_MYSQL_DEFAULT,              'default'),
            (STC_MYSQL_COMMENT,              'comment'),
            (STC_MYSQL_COMMENTLINE,          'comment line'),
            (STC_MYSQL_DATABASEOBJECT,       'database object'),
            (STC_MYSQL_DQSTRING,             'double quoted string'),
            (STC_MYSQL_FUNCTION,             'function'),
            (STC_MYSQL_HIDDENCOMMAND,        'hidden command'),
            (STC_MYSQL_IDENTIFIER,           'identifier'),
            (STC_MYSQL_KEYWORD,              'keyword'),
            (STC_MYSQL_KNOWNSYSTEMVARIABLE,  'known system variable'),
            (STC_MYSQL_MAJORKEYWORD,         'major keyword'),
            (STC_MYSQL_NUMBER,               'number'),
            (STC_MYSQL_OPERATOR,             'operator'),
            (STC_MYSQL_PROCEDUREKEYWORD,     'procedure keyword'),
            (STC_MYSQL_QUOTEDIDENTIFIER,     'quoted identifier'),
            (STC_MYSQL_SQSTRING,             'single quoted string'),
            (STC_MYSQL_STRING,               'string'),
            (STC_MYSQL_SYSTEMVARIABLE,       'system variable'),
            (STC_MYSQL_USER1,                'user 1'),
            (STC_MYSQL_USER2,                'user 2'),
            (STC_MYSQL_USER3,                'user 3'),
            (STC_MYSQL_VARIABLE,             'mysql variable'),
    ]

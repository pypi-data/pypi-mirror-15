...
#def dumpBitmap(bmp):
#    global counter
#    name = '/home/mel/pythonProjects/proCxx/debug/bmp_{}.bmp'.format(counter)
...
def PrefixBitmapList(prefixBitmap, bitmapList, bitmapResult):
    ...
    for bitmap in bitmapList:
        ...
        i = i + 1
        j = j + 1
        #firstMap[bitmap] = prefixed_bitmap
    return newmap
    #bitmapList.extend(list(firstMap.values()))
    #bitmapResult.extend(list(firstMap.values()))

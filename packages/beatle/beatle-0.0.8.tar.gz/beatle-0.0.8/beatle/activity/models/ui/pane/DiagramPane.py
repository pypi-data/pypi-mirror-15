...
from  activity.models.ui import view as view
...
class DiagramPane(BasePane, ui.ClassDiagramPane):
    ...
    def _bind_events(self):
        ...
        # save diagram
        self.BindSpecial(wx.EVT_UPDATE_UI, self.OnUpdateSave, id=app.ID_SAVE_PROJECT)
        self.BindSpecial(wx.EVT_MENU, self.OnSave, id=app.ID_SAVE_PROJECT)
        # delete element
        ...
        # close pane
        self.BindSpecial(wx.EVT_MENU, frame.CloseCurrentDocPane, id=CLOSE_PANE_ID)
        # add relations
    ...
    @tran.TransactionalMethod('delete elements')
    ...
    @tran.TransactionalMethod('modify diagram')
    ...
    @tran.TransactionalMethod('add class')
    def OnAddClass(self, event):
        ...
        dialog = mdlg.ClassDialog(self, parent)
    ...
    def OnSelectClasses(self, event):
        ...
        mdlg.SelectClassesDialog(self, self._object).ShowModal()

    @tran.TransactionalMethod('add diagram note')
    def OnDiagramAddNote(self, event):
        """Handles add note to diagram"""
        position = self.GetLocalPosition()
        dialog = mdlg.NoteDialog(self)
    ...
    @wxx.CreationDialog(mdlg.RelationDialog, model.cc.Relation)

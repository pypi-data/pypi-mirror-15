...
class FilesView(BaseView, ui.FilesView):
    ...
    @tran.TransactionalMethod('add new file {}')
    ...
    @tran.TransactionalMethod('add new dir {}')
    ...
    def OnDelete(self, event):
        ...
        if type(obj) is model.file.Dir:
            stack.instance.SetName('delete dir {}'.format(obj.name))
        elif type(obj) is model.file.File:
            stack.instance.SetName('delete file {}'.format(obj.name))
        obj.Delete()
        return True
    ...
    def OnRunFile(self, event):
        ...
        if hasattr(self.selected, '_pane') and self.selected._pane:
            self.selected._pane.Commit()
        self.frame.RunPythonScript(self.selected._file)

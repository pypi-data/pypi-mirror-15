...
from activity.tasks.ui import dlg
...
class TasksView(BaseView, ui.TasksView):
    ...
    # add folder
    _addFolderId = ID.register('add-folder')
    # add task
    _newTaskId = ID.register('add-task')
    # task list (pending and current)
    _taskList = ID.register('task-list')

...
class ModelsView(BaseView, ui.ModelsView):
    ...
    def _create_menus(self):
        ...
        self._menuAddCCElements = wx.Menu()

        self._addModule = wx.MenuItem(self._menuAddCCElements, self._addModuleId,
        ...
        self._menuAddCCElements.AppendItem(self._addModule)

        self._addNamespace = wx.MenuItem(self._menuAddCCElements, self._addNamespaceId,
        ...
        self._menuAddCCElements.AppendItem(self._addNamespace)

        self._addType = wx.MenuItem(self._menuAddCCElements, self._addTypeId,
            u"Type ...\tCtrl+Alt+T", u"add type", wx.ITEM_NORMAL)
        self._addType.SetBitmap(wx.Bitmap(u"app/res/type.xpm", wx.BITMAP_TYPE_ANY))
        self._menuAddCCElements.AppendItem(self._addType)

        self._addEnum = wx.MenuItem(self._menuAddCCElements, self._addEnumId,
            u"Enum...\tShift+Ctrl+E", u"add enum", wx.ITEM_NORMAL)
        self._addEnum.SetBitmap(wx.Bitmap(u"app/res/enum.xpm", wx.BITMAP_TYPE_ANY))
        self._menuAddCCElements.AppendItem(self._addEnum)

        self._addClass = wx.MenuItem(self._menuAddCCElements, self._addClassId,
            u"Class ...\tCtrl+Alt+C", u"add class", wx.ITEM_NORMAL)
        self._addClass.SetBitmap(wx.Bitmap(u"app/res/class.xpm", wx.BITMAP_TYPE_ANY))
        self._menuAddCCElements.AppendItem(self._addClass)

        self._addInheritance = wx.MenuItem(self._menuAddCCElements, self._addInheritanceId,
        ...
        self._menuAddCCElements.AppendItem(self._addInheritance)

        self._setFriendship = wx.MenuItem(self._menuAddCCElements, self._setFriendshipId,
        ...
        self._menuAddCCElements.AppendItem(self._setFriendship)

        self._addMember = wx.MenuItem(self._menuAddCCElements, self._addMemberId,
        ...
        self._menuAddCCElements.AppendItem(self._addMember)

        self._addConstructor = wx.MenuItem(self._menuAddCCElements, self._addConstructorId,
        ...
        self._menuAddCCElements.AppendItem(self._addConstructor)

        self._addMethod = wx.MenuItem(self._menuAddCCElements, self._addMethodId,
        ...
        self._menuAddCCElements.AppendItem(self._addMethod)

        self._addDestructor = wx.MenuItem(self._menuAddCCElements, self._addDestructorId,
        ...
        self._menuAddCCElements.AppendItem(self._addDestructor)

        self._addArgument = wx.MenuItem(self._menuAddCCElements, self._addArgumentId,
        ...
        self._menuAddCCElements.AppendItem(self._addArgument)

        self._addFunction = wx.MenuItem(self._menuAddCCElements, self._addFunctionId,
        ...
        self._menuAddCCElements.AppendItem(self._addFunction)

        self._addVariable = wx.MenuItem(self._menuAddCCElements, self._addVariableId,
        ...
        self._menuAddCCElements.AppendItem(self._addVariable)

        self._addVirtualMethod = wx.MenuItem(self._menuAddCCElements, self._addVirtualMethodId,
        ...
        self._menuAddCCElements.AppendItem(self._addVirtualMethod)

        self._menuAddCC.AppendSubMenu(self._menuAddCCElements, u"Elements")
    ...
    def NodeOnAddClass(self, event):
        ...
        if project is None:
            return
        if not s.inner_class_container:
            return
    ...
    def DoRenderAddElement(self, obj):
        ...
        treeOrder = [
            ...
            model.ClassDiagram, model.cc.Type, model.Folder, model.Library,
    ...
    def OnDelete(self, event):
        ...
        obj = self.selected
        aliasMap = {
            model.cc.Class: "c++ class {}", model.py.Class: "python class {}",
            model.cc.Inheritance: "inheritance {}", model.py.Inheritance: "c++ inheritance from {}",
            model.py.Inheritance: "inheritance {}", model.py.Inheritance: "python inheritance from {}",
            model.py.Package: "python package {}",
            model.cc.Argument: "c++ method argument {}",
            model.py.Argument: "python method argument {}",
            model.py.ArgsArgument: "python method argument list",
            model.py.KwArgsArgument: "python method argument dict",
            model.cc.Constructor: "constructor {}",
            model.py.InitMethod: "__init__ method",
            model.cc.Destructor: "destructor {}", model.Folder: "folder {}",
            model.cc.IsClassMethod: "method {}", model.cc.Friendship: "friend {}",
            model.cc.MemberData: "member {}", model.cc.MemberMethod: "c++ method {}",
            model.py.MemberMethod: "python method {}",
            model.ClassDiagram: "diagram {}", model.Project: "project {}",
            model.cc.RelationFrom: "relation {}", model.cc.RelationTo: "relation {}",
            model.cc.Namespace: "namespace {}", model.cc.Type: "type {}",
            model.cc.Module: 'c++ module "{}"', model.cc.Function: "c++ function {}",
            model.cc.pyBoostModule: 'c++ boost.python "{}"',
            model.py.Function: 'python function {}',
            model.py.Module: 'python module "{}"', model.Library: "library {}",
            model.cc.Data: 'c++ variable {}', model.py.Data: 'python variable {}',
            model.py.Import: 'python import {}', model.py.Decorator: 'python decorator {}',
    ...
    @tran.TransactionalMethod('apply contexts to {}')
    ...
    @tran.TransactionalMethod('edit {} user sections')
    ...
    @tran.TransactionalMethod('add folder {}')
    ...
    @tran.TransactionalMethod('add class diagram {}')
    ...
    @tran.TransactionalMethod('add c++ module {}')
    ...
    @tran.TransactionalMethod('add namespace {}')
    ...
    @tran.TransactionalMethod('add type {}')
    ...
    @tran.TransactionalMethod('add c++ class {}')
    ...
    def OnUpdateAddInheritance(self, event):
        ...
        v = self.selected
        if v:
            v = v.inner_inheritance_container
            if v:
                if v.project._language == 'c++':
                    event.Enable(True)
                    return
    ...
    @tran.TransactionalMethod('add c++ {} inheritance')
    ...
    @tran.TransactionalMethod('add c++ {} class member')
    ...
    @tran.TransactionalMethod('add {} constructor')
    ...
    @tran.TransactionalMethod('add c++ method {}')
    ...
    def OnUpdateAddDestructor(self, event):
        ...
        if v:
            ...
            if v:
                if v.project._language == 'c++':
                    cls = v.inner_class
                    event.Enable(not cls(model.cc.Destructor,
                        filter=lambda x: x.inner_class == cls, cut=True))
                    return
        event.Enable(False)

    @tran.TransactionalMethod('add {} destructor')
    ...
    @tran.TransactionalMethod('add c++ method argument {}')
    ...
    @tran.TransactionalMethod('add c++ function {}')
    ...
    @tran.TransactionalMethod('add c++ variable {}')
    ...
    def OnUpdateAddIsClassMethod(self, event):
        ...
        event.Enable(
            bool(self.selected and self.selected.inner_class and
             len(self.selected.inner_class._deriv) > 0))
    ...
    def OnUpdateAddRelation(self, event):
        ...
        event.Enable(bool(self.selected and self.selected.inner_relation_container))
    ...
    def OnRuleOfThree(self, event):
        ...
        if not bcpyo:
            ...
            model.cc.Argument(parent=assig, type=model.cc.typeinst(type=cls,
                ref=True, const=True), name='ref{}'.format(cls._name))
        return True
    ...
    @wxx.CreationDialog(ui_dlg.BoostPythonModuleDialog, model.cc.Module)
    ...
    @tran.TransactionalMethod('add python pakage {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python module {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add phython import {}')
    ...
    def OnUpdateAddPyClass(self, event):
        ...
        if v:
            ...
            if v:
                v = v.project
                if v._language == 'python':
                    event.Enable(True)
                    return
        event.Enable(False)

    @deco.with_python_export
    @tran.TransactionalMethod('add python class {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python {} inheritance')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python method {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python method argument {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python {} class member')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python function {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python variable {}')
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('edit {} decorators')

...
class Client(object):
    ...
    def read(self, path):
        ...
        """
        try:
            return self.get('/v1/{0}'.format(path)).json()
    ...
    def list(self, path):
        ...
        try:
            ...
            return self.get('/v1/{}'.format(path), params=payload).json()
        except exceptions.InvalidPath:
            return None
    ...
    def write(self, path, **kwargs):
        ...
        PUT /<path>
        """
        response = self.put('/v1/{0}'.format(path), json=kwargs)
    ...
    def delete(self, path):
        ...
        DELETE /<path>
        """
        self.delete('/v1/{0}'.format(path))

    def is_initialized(self):
        """
        GET /sys/init
        """
        return self.get('/v1/sys/init').json()['initialized']
    ...
    def initialize(self, secret_shares=5, secret_threshold=3, pgp_keys=None):
        ...
        return self.put('/v1/sys/init', json=params).json()
    ...
    def seal_status(self):
        ...
        GET /sys/seal-status
        """
        return self.get('/v1/sys/seal-status').json()
    ...
    def unseal(self, key):
        ...
        return self.put('/v1/sys/unseal', json=params).json()
    ...
    def key_status(self):
        ...
        GET /sys/key-status
        """
        return self.get('/v1/sys/key-status').json()

    def rotate(self):
        """
        PUT /sys/rotate
        """
        self.put('/v1/sys/rotate')
    ...
    def rekey_status(self):
        ...
        GET /sys/rekey/init
        """
        return self.get('/v1/sys/rekey/init').json()
    ...
    def start_rekey(self, secret_shares=5, secret_threshold=3, pgp_keys=None):
        ...
        resp = self.put('/v1/sys/rekey/init', json=params)
        if resp.text:
            return resp.json()
    ...
    def rekey(self, key, nonce=None):
        ...
        return self.put('/v1/sys/rekey/update', json=params).json()
    ...
    def ha_status(self):
        ...
        GET /sys/leader
        """
        return self.get('/v1/sys/leader').json()
    ...
    def renew_secret(self, lease_id, increment=None):
        ...
        return self.post('/v1/sys/renew/{0}'.format(lease_id), json=params).json()

    def revoke_secret(self, lease_id):
        """
        PUT /sys/revoke/<lease id>
        """
        self.put('/v1/sys/revoke/{0}'.format(lease_id))

    def revoke_secret_prefix(self, path_prefix):
        """
        PUT /sys/revoke-prefix/<path prefix>
        """
        self.put('/v1/sys/revoke-prefix/{0}'.format(path_prefix))

    def revoke_self_token(self):
        """
        PUT /auth/token/revoke-self
        """
        self.put('/v1/auth/token/revoke-self')

    def list_secret_backends(self):
        """
        GET /sys/mounts
        """
        return self.get('/v1/sys/mounts').json()
    ...
    def enable_secret_backend(self, backend_type, description=None, mount_point=None, config=None):
        ...
        self.post('/v1/sys/mounts/{0}'.format(mount_point), json=params)

    def disable_secret_backend(self, mount_point):
        """
        DELETE /sys/mounts/<mount point>
        """
        self.delete('/v1/sys/mounts/{0}'.format(mount_point))
    ...
    def remount_secret_backend(self, from_mount_point, to_mount_point):
        ...
        self.post('/v1/sys/remount', json=params)

    def list_policies(self):
        """
        GET /sys/policy
        """
        return self.get('/v1/sys/policy').json()['policies']
    ...
    def get_policy(self, name):
        ...
        """
        try:
            return self.get('/v1/sys/policy/{0}'.format(name)).json()['rules']
        except exceptions.InvalidPath:
            return None
    ...
    def set_policy(self, name, rules):
        ...
        self.put('/v1/sys/policy/{0}'.format(name), json=params)

    def delete_policy(self, name):
        """
        DELETE /sys/policy/<name>
        """
        self.delete('/v1/sys/policy/{0}'.format(name))

    def list_audit_backends(self):
        """
        GET /sys/audit
        """
        return self.get('/v1/sys/audit').json()
    ...
    def enable_audit_backend(self, backend_type, description=None, options=None, name=None):
        ...
        self.post('/v1/sys/audit/{0}'.format(name), json=params)

    def disable_audit_backend(self, name):
        """
        DELETE /sys/audit/<name>
        """
        self.delete('/v1/sys/audit/{0}'.format(name))
    ...
    def audit_hash(self, name, input):
        ...
        return self.post('/v1/sys/audit-hash/{0}'.format(name), json=params).json()
    ...
    def create_token(self, id=None, policies=None, meta=None,
        ...
        if orphan:
            return self.post('/v1/auth/token/create-orphan', json=params).json()
        else:
            return self.post('/v1/auth/token/create', json=params).json()
    ...
    def lookup_token(self, token=None):
        ...
        """
        if token:
            return self.get('/v1/auth/token/lookup/{0}'.format(token)).json()
        else:
            return self.get('/v1/auth/token/lookup-self').json()
    ...
    def revoke_token(self, token, orphan=False):
        ...
        """
        if orphan:
            self.post('/v1/auth/token/revoke-orphan/{0}'.format(token))
        else:
            self.post('/v1/auth/token/revoke/{0}'.format(token))

    def revoke_token_prefix(self, prefix):
        """
        POST /auth/token/revoke-prefix/<prefix>
        """
        self.post('/v1/auth/token/revoke-prefix/{0}'.format(prefix))
    ...
    def renew_token(self, token=None, increment=None):
        ...
        if token:
            return self.post('/v1/auth/token/renew/{0}'.format(token), json=params).json()
        else:
            return self.post('/v1/auth/token/renew-self', json=params).json()
    ...
    def create_userpass(self, username, password, policies, mount_point='userpass'):
        ...
        return self.post('/v1/auth/{}/users/{}'.format(mount_point, username), json=params)

    def delete_userpass(self, username, mount_point='userpass'):
        """
        DELETE /auth/<mount point>/users/<username>
        """
        return self.delete('/v1/auth/{}/users/{}'.format(mount_point, username))
    ...
    def create_app_id(self, app_id, policies, display_name=None, mount_point='app-id', **kwargs):
        ...
        return self.post('/v1/auth/{}/map/app-id/{}'.format(mount_point, app_id), json=params)
    ...
    def create_user_id(self, user_id, app_id, cidr_block=None, mount_point='app-id', **kwargs):
        ...
        return self.post('/v1/auth/{}/map/user-id/{}'.format(mount_point, user_id), json=params)
    ...
    def list_auth_backends(self):
        ...
        GET /sys/auth
        """
        return self.get('/v1/sys/auth').json()
    ...
    def enable_auth_backend(self, backend_type, description=None, mount_point=None):
        ...
        self.post('/v1/sys/auth/{0}'.format(mount_point), json=params)

    def disable_auth_backend(self, mount_point):
        """
        DELETE /sys/auth/<mount point>
        """
        self.delete('/v1/sys/auth/{0}'.format(mount_point))

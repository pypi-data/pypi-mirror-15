...
class TestLPSHTML(object):
    """Class tests the acceptance arbitrary HTML in LP schedule.
    """
    ...
    def setup_class(self):
        ...
        self.MD_FILE = path.join('files', 'lp-sch-html.md')
        self.MD_FILE_CONTENT = read_file(self.MD_FILE)
    ...
    def test_inline_html(self):
        """Tests if the acceptance of inline HTML in LP schedule.
        """
        lp_html = RenderHTML(self.lps_dict, self.SCH_TEMPLATE)
        #self.soup = BeautifulSoup(lp_html, 'html.parser')

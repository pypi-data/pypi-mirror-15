...
class RainwaveSong(dict):
    ...
    def rating_allowed(self):
        """A boolean representing whether the listener can current rate the
        song."""
    ...
    def request_rank(self):
        """The position of the song when songs on the channel are ranked by
        how often they are requested. The most-requested song will have
        :attr:`rating_rank` == 1."""
        return self['rating_rank']

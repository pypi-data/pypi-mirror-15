...
'''
    ...
    if not g['cfa'] or data.in_memory or is1d_coord:
        ...
        try:
            ...
            raise TypeError(
"Can't write data type {0!r} (from {1!r}) to a {2} file. Use a netCDF4 format or use the 'single' or `datatype' parameters or change the datatype before writing".format(

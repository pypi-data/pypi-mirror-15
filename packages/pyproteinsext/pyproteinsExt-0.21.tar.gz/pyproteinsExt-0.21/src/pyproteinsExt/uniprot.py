...
class EntrySet(pyproteins.container.customCollection.EntrySet):
    def __init__(self):
        pyproteins.container.customCollection.EntrySet.__init__(self, collectionPath="/Users/guillaumelaunay/work/data/uniprot", constructor=Entry, typeCheck=isValidID, indexer=strip)
...
class Entry(pyproteins.container.Core.Container):
    ...
    def __init__(self, id, baseUrl="http://www.uniprot.org/uniprot/", fileName=None):
        ...
        # TO DO
        #self.IDparser(id) #strip uniprotID and isoform

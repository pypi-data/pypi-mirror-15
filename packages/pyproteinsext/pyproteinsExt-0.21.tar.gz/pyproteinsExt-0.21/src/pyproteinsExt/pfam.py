...
class EntrySet(pyproteins.container.customCollection.EntrySet):
    def __init__(self):
        pyproteins.container.customCollection.EntrySet.__init__(self, collectionPath="/Users/guillaumelaunay/work/data/pfam", constructor=Entry, typeCheck=None, indexer=strip)

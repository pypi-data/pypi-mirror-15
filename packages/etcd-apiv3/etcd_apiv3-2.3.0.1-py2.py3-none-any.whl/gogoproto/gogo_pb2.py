...
goproto_getters = _descriptor.FieldDescriptor(
  name='goproto_getters', full_name='gogoproto.goproto_getters', index=30,
...
goproto_stringer = _descriptor.FieldDescriptor(
  name='goproto_stringer', full_name='gogoproto.goproto_stringer', index=31,
...
verbose_equal = _descriptor.FieldDescriptor(
  name='verbose_equal', full_name='gogoproto.verbose_equal', index=32,
...
face = _descriptor.FieldDescriptor(
  name='face', full_name='gogoproto.face', index=33,
...
gostring = _descriptor.FieldDescriptor(
  name='gostring', full_name='gogoproto.gostring', index=34,
...
populate = _descriptor.FieldDescriptor(
  name='populate', full_name='gogoproto.populate', index=35,
...
stringer = _descriptor.FieldDescriptor(
  name='stringer', full_name='gogoproto.stringer', index=36,
...
onlyone = _descriptor.FieldDescriptor(
  name='onlyone', full_name='gogoproto.onlyone', index=37,
...
equal = _descriptor.FieldDescriptor(
  name='equal', full_name='gogoproto.equal', index=38,
...
description = _descriptor.FieldDescriptor(
  name='description', full_name='gogoproto.description', index=39,
...
testgen = _descriptor.FieldDescriptor(
  name='testgen', full_name='gogoproto.testgen', index=40,
...
benchgen = _descriptor.FieldDescriptor(
  name='benchgen', full_name='gogoproto.benchgen', index=41,
...
marshaler = _descriptor.FieldDescriptor(
  name='marshaler', full_name='gogoproto.marshaler', index=42,
...
unmarshaler = _descriptor.FieldDescriptor(
  name='unmarshaler', full_name='gogoproto.unmarshaler', index=43,
...
stable_marshaler = _descriptor.FieldDescriptor(
  name='stable_marshaler', full_name='gogoproto.stable_marshaler', index=44,
...
sizer = _descriptor.FieldDescriptor(
  name='sizer', full_name='gogoproto.sizer', index=45,
...
unsafe_marshaler = _descriptor.FieldDescriptor(
  name='unsafe_marshaler', full_name='gogoproto.unsafe_marshaler', index=46,
...
unsafe_unmarshaler = _descriptor.FieldDescriptor(
  name='unsafe_unmarshaler', full_name='gogoproto.unsafe_unmarshaler', index=47,
...
goproto_extensions_map = _descriptor.FieldDescriptor(
  name='goproto_extensions_map', full_name='gogoproto.goproto_extensions_map', index=48,
...
goproto_unrecognized = _descriptor.FieldDescriptor(
  name='goproto_unrecognized', full_name='gogoproto.goproto_unrecognized', index=49,
...
protosizer = _descriptor.FieldDescriptor(
  name='protosizer', full_name='gogoproto.protosizer', index=50,
...
nullable = _descriptor.FieldDescriptor(
  name='nullable', full_name='gogoproto.nullable', index=51,
...
embed = _descriptor.FieldDescriptor(
  name='embed', full_name='gogoproto.embed', index=52,
...
customtype = _descriptor.FieldDescriptor(
  name='customtype', full_name='gogoproto.customtype', index=53,
...
customname = _descriptor.FieldDescriptor(
  name='customname', full_name='gogoproto.customname', index=54,
...
jsontag = _descriptor.FieldDescriptor(
  name='jsontag', full_name='gogoproto.jsontag', index=55,
...
moretags = _descriptor.FieldDescriptor(
  name='moretags', full_name='gogoproto.moretags', index=56,
...
casttype = _descriptor.FieldDescriptor(
  name='casttype', full_name='gogoproto.casttype', index=57,
...
castkey = _descriptor.FieldDescriptor(
  name='castkey', full_name='gogoproto.castkey', index=58,
...
castvalue = _descriptor.FieldDescriptor(
  name='castvalue', full_name='gogoproto.castvalue', index=59,

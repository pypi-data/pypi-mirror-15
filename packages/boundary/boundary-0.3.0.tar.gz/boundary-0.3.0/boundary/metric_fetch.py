...
class MetricFetch(MetricCommon):
    def __init__(self):
    ...
    def add_filter_arguments(self):
        self.parser.add_argument('-b', '--enabled', dest="enabled", action='store_true', required=False,
                                 help='Filter the list of metrics to only return enabled metrics')
        self.parser.add_argument('-c', '--custom', dest="custom", action='store_true', required=False,

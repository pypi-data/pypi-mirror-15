...
class SubscriberApi(object):
    ...
    # this service
    _ALL_SCOPES = ('https://www.googleapis.com/auth/pubsub',
    ...
    def create_subscription(self,
        ...
        Example:
          >>> from gcloud.pubsub.subscriber_api import SubscriberApi
          >>> api = SubscriberApi()
        ...
        settings = self._defaults['create_subscription'].merge(options)
        api_call = api_callable.create_api_call(self.stub.CreateSubscription,
                                                settings=settings)
    ...
    def get_subscription(self, subscription, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.GetSubscriptionRequest(subscription=subscription)
        settings = self._defaults['get_subscription'].merge(options)
        api_call = api_callable.create_api_call(self.stub.GetSubscription,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def list_subscriptions(self, project, page_size=0, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.ListSubscriptionsRequest(project=project,
                                                  page_size=page_size)
        settings = self._defaults['list_subscriptions'].merge(options)
        api_call = api_callable.create_api_call(self.stub.ListSubscriptions,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def delete_subscription(self, subscription, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.DeleteSubscriptionRequest(subscription=subscription)
        settings = self._defaults['delete_subscription'].merge(options)
        api_call = api_callable.create_api_call(self.stub.DeleteSubscription,
                                                settings=settings)
    ...
    def modify_ack_deadline(self,
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.ModifyAckDeadlineRequest(
            subscription=subscription,
            ack_ids=ack_ids,
            ack_deadline_seconds=ack_deadline_seconds)
        settings = self._defaults['modify_ack_deadline'].merge(options)
        api_call = api_callable.create_api_call(self.stub.ModifyAckDeadline,
                                                settings=settings)
        api_call(req, metadata=self._headers)
    ...
    def acknowledge(self, subscription, ack_ids, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.AcknowledgeRequest(subscription=subscription,
                                            ack_ids=ack_ids)
        settings = self._defaults['acknowledge'].merge(options)
        api_call = api_callable.create_api_call(self.stub.Acknowledge,
                                                settings=settings)
        api_call(req, metadata=self._headers)
    ...
    def pull(self,
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.PullRequest(subscription=subscription,
                                     max_messages=max_messages,
                                     return_immediately=return_immediately)
        settings = self._defaults['pull'].merge(options)
        api_call = api_callable.create_api_call(self.stub.Pull,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def modify_push_config(self, subscription, push_config, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.ModifyPushConfigRequest(subscription=subscription,
                                                 push_config=push_config)
        settings = self._defaults['modify_push_config'].merge(options)
        api_call = api_callable.create_api_call(self.stub.ModifyPushConfig,
                                                settings=settings)
        api_call(req, metadata=self._headers)

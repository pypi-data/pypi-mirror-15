...
class PublisherApi(object):
    ...
    def create_topic(self, name, options=None):
        ...
        Example:
          >>> from gcloud.pubsub.publisher_api import PublisherApi
          >>> api = PublisherApi()
    ...
    def publish(self, topic, messages, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.PublishRequest(topic=topic, messages=messages)
        settings = self._defaults['publish'].merge(options)
        api_call = api_callable.create_api_call(self.stub.Publish,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def get_topic(self, topic, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.GetTopicRequest(topic=topic)
        settings = self._defaults['get_topic'].merge(options)
        api_call = api_callable.create_api_call(self.stub.GetTopic,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def list_topics(self, project, page_size=0, options=None):
        ...
        req = pubsub_pb2.ListTopicsRequest(project=project,
                                           page_size=page_size)
        settings = self._defaults['list_topics'].merge(options)
        api_call = api_callable.create_api_call(self.stub.ListTopics,
                                                settings=settings)
        return api_call(req, metadata=self._headers)
    ...
    def list_topic_subscriptions(self, topic, page_size=0, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.ListTopicSubscriptionsRequest(topic=topic,
                                                       page_size=page_size)
        settings = self._defaults['list_topic_subscriptions'].merge(options)
    ...
    def delete_topic(self, topic, options=None):
        ...
        Raises:
          :exc:`google.gax.errors.GaxError` if the RPC is aborted.
        """
        req = pubsub_pb2.DeleteTopicRequest(topic=topic)
        settings = self._defaults['delete_topic'].merge(options)
        api_call = api_callable.create_api_call(self.stub.DeleteTopic,
                                                settings=settings)

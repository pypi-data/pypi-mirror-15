...
pyAMI.config.endpoint_descrs['supernemo'] = {'prot': 'https', 'host': 'ami-supernemo.in2p3.fr', 'port': '443', 'path': '/AMI/servlet/net.hep.atlas.Database.Bookkeeping.AMI.Servlet.FrontEnd'}

# -*- coding: utf-8 -*-
#
# pycbrf documentation build configuration file.
#
...
project = u'pycbrf'
copyright = u'2016, Igor `idle sign` Starikov'
...
latex_documents = [
  ('index', 'pycbrf.tex', u'pycbrf Documentation',
...
man_pages = [
    ('index', 'pycbrf', u'pycbrf Documentation',

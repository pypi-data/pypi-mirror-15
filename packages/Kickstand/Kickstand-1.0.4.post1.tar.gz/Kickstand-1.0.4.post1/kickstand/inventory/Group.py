...
class Group(object):
  """Object representing a Group from the Kickstand server."""
  ...
  def commit(self):
    ...
    if( not self.isCreated() ):
      result = self._communicator.post('/inventory/groups',
          data=self._data())
    else:
      result = self._communicator.put('/inventory/groups/%d' % self._id,
          data=self._data())

...
.. image:: https://coveralls.io/repos/xlcnd/isbnlib/badge.svg?branch=v3.6.1
    :target: https://coveralls.io/r/xlcnd/isbnlib?branch=v3.6.1
    :alt: Coverage

.. image:: https://travis-ci.org/xlcnd/isbnlib.svg?branch=v3.6.1
    :target: https://travis-ci.org/xlcnd/isbnlib
    :alt: Built Status

.. image:: https://ci.appveyor.com/api/projects/status/github/xlcnd/isbnlib?branch=v3.6.1&svg=true

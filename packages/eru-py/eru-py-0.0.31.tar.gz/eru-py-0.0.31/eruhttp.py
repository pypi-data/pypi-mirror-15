...
class EruClient(object):
    ...
    def respawn_container(self, container_id):
        c = self.get_container(container_id)
        ncore = self.tell_ncore(c)
        networks = self.tell_networks(c)
        result = self.deploy_private(c['podname'],
                                     c['appname'],
                                     ncore,
                                     1,
                                     c['version'],
                                     ...
                                     c['env'],
                                     networks)
        self.remove_containers(c['container_id'])
        return result

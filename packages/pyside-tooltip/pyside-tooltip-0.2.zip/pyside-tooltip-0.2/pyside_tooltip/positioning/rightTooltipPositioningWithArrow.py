...
class RightTooltipPositioningWithArrow(TooltipPositioningWithArrow):
	...
	def _getContainerFor(self, tooltip, main_window):
		container = super(RightTooltipPositioningWithArrow, self)._getHorizontalContainerFor(tooltip, main_window)
	...
	def isPossibleFor(self, hovered_widget, tooltip, main_window):
		minimized = super(RightTooltipPositioningWithArrow, self).isPossibleFor(hovered_widget, tooltip, main_window)

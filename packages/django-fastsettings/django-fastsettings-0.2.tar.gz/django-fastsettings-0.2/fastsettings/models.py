...
import json
import fastsettings.projectsettings as fstsettings
import logging
...
class Settings(models.Model):
    ...
    action_int = models.IntegerField(blank=True, null=True, help_text="The setting integer. NOTE: If only using integer, check use_integer box and uncheck use_string!")
    # Can be used for anything. #
    action_str = models.TextField(blank=True, null=True, help_text='The setting string. (json: {"key:"val","key2":2}) NOTE: If only using string, check use_string box and uncheck use_integer!')
...
def on_settings_save(sender,**kwargs):
    ...
    if(settingobj is not None):
        try:
            ...
            the_setting = {'action_int': settingobj.action_int, 'action_str': settingobj.action_str, 'use_integer': settingobj.use_integer, 'use_string': settingobj.use_string}

...
cdef void cfuvw(double *c, int m1, int m2, int n2, double r2, double L,
    ...
    cdef double sini1x, sini2x, sinj2t, cosj2t, x, t, u, v, w
    ...
    for i in range(size):
        ...
        for j2 in range(j0, n2+j0):
            ...
            for i2 in range(i0, m2+i0):
                ...
                v += c[col+2]*sini2x*sinj2t
                v += c[col+3]*sini2x*cosj2t
...
cdef void cfv(double *c, int m1, int m2, int n2, double *xs, double *ts,
    ...
    cdef int i1, i2, j2, col, i
    cdef double sini1x, sini2x, sinj2t, cosj2t, x, t, v
...
cdef void cfgss(double[:,::1] gss, int m1, int m2, int n2,
                double r2, double x, double t,
                double L, double cosa, double tLA) nogil:
    cdef double sini1x, sini2x, sinj2t, cosj2t
    ...
    for i2 in range(i0, m2+i0):
        ...
        for j2 in range(j0, n2+j0):
            ...
            sinj2t = sin(j2*t)
            cosj2t = cos(j2*t)
            gss[0, col+0] = sini2x*sinj2t
            gss[0, col+1] = sini2x*cosj2t

            gss[1, col+2] = sini2x*sinj2t
            gss[1, col+3] = sini2x*cosj2t

            gss[2, col+4] = sini2x*sinj2t
            gss[2, col+5] = sini2x*cosj2t

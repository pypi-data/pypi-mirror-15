...
def watershed_old(map):
    ...
    WARNING: Ths code is buggy. Retained only for backwards compatibility.
    Use the new watershed() method instead.
    '''
...
def watershed(map):
    ...
    map.ID = watershed(-a, markers, mask = a > 0)

...
def pczdump(args):
    ...
    if args.evec is not None:
        pcz_instance = Pczfile(args.input)
        e = pcz_instance.evecs[int(args.evec)]
        ...
        pcz_instance = Pczfile(args.input)
        p = pcz_instance.projs[int(args.proj)]
        if args.output is not None:
        ...
        pcz_instance = Pczfile(args.input)
        evec = pcz_instance.evecs[int(args.fluc)]
        ...
        pcz_instance = Pczfile(args.input)
        avg = pcz_instance.avg
        evec = pcz_instance.evecs[int(args.anim)]
        proj = pcz_instance.projs[int(args.anim)]

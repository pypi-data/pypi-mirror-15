...
class DialerAction(object):
    ...
    def action_type_name(self, action_type_name):
        ...
        if action_type_name not in allowed_values:
            raise ValueError(
                "Invalid value for `action_type_name`, must be one of {0}"
                .format(allowed_values)
            )
    ...
    def update_option(self, update_option):
        ...
        if update_option not in allowed_values:
            raise ValueError(
                "Invalid value for `update_option`, must be one of {0}"
                .format(allowed_values)
            )

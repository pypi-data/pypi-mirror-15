...
class RetentionDuration(object):
    ...
    def __init__(self):
        """
        RetentionDuration - a model defined in Swagger
    ...
    def archive_retention(self):
        """
        Gets the archive_retention of this RetentionDuration.


        :return: The archive_retention of this RetentionDuration.
    ...
    def archive_retention(self, archive_retention):
        """
        Sets the archive_retention of this RetentionDuration.


        :param archive_retention: The archive_retention of this RetentionDuration.
    ...
    def delete_retention(self):
        """
        Gets the delete_retention of this RetentionDuration.


        :return: The delete_retention of this RetentionDuration.
    ...
    def delete_retention(self, delete_retention):
        """
        Sets the delete_retention of this RetentionDuration.


        :param delete_retention: The delete_retention of this RetentionDuration.

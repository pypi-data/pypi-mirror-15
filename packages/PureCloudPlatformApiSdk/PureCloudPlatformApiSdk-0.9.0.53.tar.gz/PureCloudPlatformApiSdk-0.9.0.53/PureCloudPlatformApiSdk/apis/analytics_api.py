...
class AnalyticsApi(object):
    ...
    def delete_reporting_schedules_schedule_id(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_reporting_schedules_schedule_id(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_reporting_schedules_schedule_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `delete_reporting_schedules_schedule_id`")
    ...
    def get_reporting_metadata(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_metadata(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_metadata" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_reporting_report_id_metadata(self, report_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_report_id_metadata(report_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_report_id_metadata" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('report_id' not in params) or (params['report_id'] is None):
            raise ValueError("Missing the required parameter `report_id` when calling `get_reporting_report_id_metadata`")
    ...
    def get_reporting_reportformats(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_reportformats(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_reportformats" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_reporting_schedules(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_schedules(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_schedules" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_reporting_schedules_schedule_id(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_schedules_schedule_id(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_schedules_schedule_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `get_reporting_schedules_schedule_id`")
    ...
    def get_reporting_schedules_schedule_id_history(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_schedules_schedule_id_history(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_schedules_schedule_id_history" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `get_reporting_schedules_schedule_id_history`")
    ...
    def get_reporting_schedules_schedule_id_history_latest(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_schedules_schedule_id_history_latest(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_schedules_schedule_id_history_latest" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `get_reporting_schedules_schedule_id_history_latest`")
    ...
    def get_reporting_schedules_schedule_id_history_run_id(self, run_id, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_schedules_schedule_id_history_run_id(run_id, schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_schedules_schedule_id_history_run_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('run_id' not in params) or (params['run_id'] is None):
            raise ValueError("Missing the required parameter `run_id` when calling `get_reporting_schedules_schedule_id_history_run_id`")
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `get_reporting_schedules_schedule_id_history_run_id`")
    ...
    def get_reporting_timeperiods(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_timeperiods(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reporting_timeperiods" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def post_reporting_schedules(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_reporting_schedules(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ReportSchedule body: ReportSchedule
        :return: ReportSchedule
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_reporting_schedules" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def post_reporting_schedules_schedule_id_runreport(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_reporting_schedules_schedule_id_runreport(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_reporting_schedules_schedule_id_runreport" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `post_reporting_schedules_schedule_id_runreport`")
    ...
    def put_reporting_schedules_schedule_id(self, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_reporting_schedules_schedule_id(schedule_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_reporting_schedules_schedule_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schedule_id' is set
        if ('schedule_id' not in params) or (params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `put_reporting_schedules_schedule_id`")

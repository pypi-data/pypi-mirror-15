...
class FileRange(object):
    ...
    def __str__(self):
        ...
        file_range_str = 'file_path:%s id:%d,range_start:%ld,range_end:%ld,range_size:%ld,is_last_range:%s' % (self.file_path,self.range_id,self.start,self.end,self.size,self.is_last)

...
class Ec2InstanceDb(BaseDb):
    ...
    def save_config(self,image_id,keyname,security_group_id,subnet_id,pem_file_path):
        ...
        insert_sql = '''
            insert into instance(keyname,subnet_id,image_id,security_group_id,key_path) values(?,?,?,?,?)
        '''
        data = [(keyname,subnet_id,image_id,security_group_id,pem_file_path),]
        self.save(insert_sql,data)

    def load_default_config(self):

        query_sql = '''
            select subnet_id,keyname,security_group_id,image_id,key_path from instance 
        '''

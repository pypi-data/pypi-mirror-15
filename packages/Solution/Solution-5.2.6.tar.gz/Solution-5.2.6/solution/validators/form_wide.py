...
# TODO: test
# class GreaterOrEqual(FormValidator):

#     """Form validator that assert that one field value is bigger or equal than the other
...
#     """
#     message = u'{name2} must be greater than or equal to {value1}.'

#     def __init__(self, name1, name2, message=None):
#         self.name1 = name1
#         self.name2 = name2
#         self.message = message
...
#     def __call__(self, data=None, form=None):
#         data = data or {}
#         value1 = data.get(self.name1)
#         value2 = data.get(self.name2)
#         self.message.format(

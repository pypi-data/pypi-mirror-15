...
class financial(object):
    ...
    account_sale_debit_note = APIClient(
        application=_application_name,
        service_uri='AccountSaleDebitNote/')
    account_sale_debit_note_contra = APIClient(
        application=_application_name,
        service_uri='AccountSaleDebitNote/{idAddress}/Contra/')
    ...
    cash_sale_debit_note = APIClient(
        application=_application_name,
        service_uri='CashSaleDebitNote/')
    cash_sale_debit_note_contra = APIClient(
        application=_application_name,
        service_uri='CashSaleDebitNote/{idAddress}/Contra/')

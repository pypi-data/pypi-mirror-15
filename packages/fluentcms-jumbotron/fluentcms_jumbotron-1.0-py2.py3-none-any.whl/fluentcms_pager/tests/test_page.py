...
from fluentcms_jumbotron.models import PagerItem
...
class PagerTests(TestCase):
    ...
    @classmethod
    def create_page(cls, slug, position, **jumbotron_kwargs):
        """
        ...
        PagerItem.objects.create_for_placeholder(placeholder, **jumbotron_kwargs)
        return page

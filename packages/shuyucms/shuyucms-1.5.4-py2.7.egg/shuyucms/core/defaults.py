"""
Default settings for the ``shuyucms.core`` app. Each of these can be
...
register_setting(
    ...
    description=_("shuyucms's caching uses a technique know as mint "
...
if "shuyucms.blog" in settings.INSTALLED_APPS:
    dashboard_tags = (
        ("blog_tags.quick_blog", "shuyucms_tags.app_list"),
        ("comment_tags.recent_comments",),
        ("shuyucms_tags.recent_actions",),
    )
else:
    dashboard_tags = (
        ("shuyucms_tags.app_list",),
        ("shuyucms_tags.recent_actions",),
        (),
    )
...
register_setting(
    ...
    description=_("A sequence of fields that will be injected into "
                  "shuyucms's (or any library's) models. Each item in the sequence is "
...
register_setting(
    ...
    description=_("Name of the jQuery file found in "
                  "shuyucms/core/static/shuyucms/js/"),
    editable=False,
...
register_setting(
    ...
    description=_("If ``True``, each site will use its own directory within "
                  "the syfilebrowser media library."),
    editable=False,
    default=False,
)
...
register_setting(
    ...
    editable=False,
    default="shuyucms.core.forms.TinyMceWidget",
)
...
register_setting(
    ...
    editable=False,
    default=("shuyucms.utils.html.thumbnails",),
)
...
register_setting(
    ...
    description=_("Sequence of models that will be provided by default as "
                  ...
                  "``shuyucms.core.models.Displayable`` should be used."),
    editable=False,
    default=None
)
...
register_setting(
    name="LIST_PER_PAGE",
    label=_("List results per page"),
    description=_("Number of results shown in the list page."),
    editable=True,
    default=15,
)
...
register_setting(
    name="SITE_PREFIX",
    description=_("A URL prefix for mounting all of shuyucms's urlpatterns "
                  "under. When using this, you'll also need to manually apply it to "
                  "your project's root ``urls.py`` module. The root ``urls.py`` module "
                  "provided by shuyucms's ``shuyucms-project`` command contains an "
...
register_setting(
    ...
    description=_("Dotted Python path to the callable for converting "
                  ...
                  "``shuyucms.utils.urls.slugify_unicode`` which allows for non-ascii "
                  "URLs. Change to ``django.template.defaultfilters.slugify`` to use "
                  "Django's slugify function, or something of your own if required."),
    editable=False,
    default="shuyucms.utils.urls.slugify_unicode",
)
...
register_setting(
    ...
    description=_("Sequence of dotted Python paths to callable functions "
                  ...
                  "Defaults to ``shuyucms.utils.views.is_spam_akismet`` which will "
                  "use the http://akismet.com spam filtering service when the "
                  "``AKISMET_API_KEY`` setting is configured."),
    editable=False,
    default=("shuyucms.utils.views.is_spam_akismet",),
)
...
register_setting(
    ...
    editable=False,
    default="shuyucms/js/tinymce_setup.js",
)
...
# available settings. They are shuyucms specific, but their values

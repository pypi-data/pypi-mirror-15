...
from shuyucms.blog.models import BlogPost
from shuyucms.conf import settings
from shuyucms.core.models import CONTENT_STATUS_PUBLISHED
from shuyucms.generic.forms import RatingForm
...
from shuyucms.utils.tests import TestCase


class GenericTests(TestCase):
    @skipUnless("shuyucms.blog" in settings.INSTALLED_APPS,
                "blog app required")
    def test_rating(self):
        ...
        for value in settings.RATINGS_RANGE:
            ...
            response.delete_cookie(native_str("shuyucms-rating"))
    ...
    def test_comment_ratings(self):
        """
        Test that a generic relation defined on one of shuyucms's generic

...
class RichTextField(models.TextField):
    ...
    def clean(self, value, model_instance):
        ...
        """
        from shuyucms.conf import settings
        from shuyucms.core.defaults import (RICHTEXT_FILTER_LEVEL_NONE,
...
class MultiChoiceField(with_metaclass(models.SubfieldBase, models.CharField)):
    ...
    def formfield(self, *args, **kwargs):
        from shuyucms.core.forms import CheckboxSelectMultiple
        defaults = {
...
# Define a ``FileField`` that maps to syfilebrowser's ``FileBrowseField``
...
if "south" in settings.INSTALLED_APPS:
    try:
        ...
        add_introspection_rules(patterns=["shuyucms\.core\.fields\."],

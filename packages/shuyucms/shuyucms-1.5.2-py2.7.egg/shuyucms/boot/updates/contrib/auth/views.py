...
@csrf_protect
@never_cache
def login(request, template_name='admin/registration/login.html',
...
def logout(request, next_page=None,
           template_name='admin/registration/logged_out.html',
           redirect_field_name=REDIRECT_FIELD_NAME,
           current_app=None, extra_context=None):
    """
...
def password_change(request,
                    template_name='admin/registration/password_change_form.html',
...
def password_change_done(request,
                         template_name='admin/registration/password_change_done.html',
                         current_app=None, extra_context=None):
    context = {}
    if extra_context is not None:
        context.update(extra_context)

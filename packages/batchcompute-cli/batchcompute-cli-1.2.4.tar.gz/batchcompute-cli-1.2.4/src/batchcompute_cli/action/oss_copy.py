...
def copy(source, target):
    ...
    (bucket, key, region, bucket_tool) = oss_client.parse_oss_path(source)

    (target_bucket, target_key, target_region, target_bucket_tool) = oss_client.parse_oss_path(target)

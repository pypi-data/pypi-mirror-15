...
if PY2:
    ...
    import codecs
    reload(sys)
    loc = codecs.lookup(locale.getpreferredencoding()).name
    sys.setdefaultencoding(loc) # utf-8

if PY3 and sys.version_info[1]==3:
    print(yellow('WARNING: Some features do not work very well in python 3.3. Please use python 2.7, 3.4 or 3.5 instead'))

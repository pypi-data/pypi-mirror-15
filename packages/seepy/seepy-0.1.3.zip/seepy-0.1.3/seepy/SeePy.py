...
class Main(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        '''
        self.language = self.addToolBar("Language")
        self.language.addWidget(languages)
        '''
    ...
    def PreviewMarkdown(self):
        root = Tk()
        root.withdraw()
        filename = askopenfilename(parent=root,title='Open Marktdown document', filetypes=[('Markdown document', '*.md')], initialdir=ScriptCode.savedir)
        root.destroy()

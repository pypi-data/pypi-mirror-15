...
def main():
    ...
    if service_params_name == NULL_PARAMS:
    ...
    if args.dryrun:
        ...
        if files_for_boot:
            ...
            if deploy_files and deploy_files=='y':
                ...
                rendered_files = os.path.join(servicefile_path,'tmp')
                print "Files deployed to S3. Rendered contents can be viewed at: %s"%(rendered_files)

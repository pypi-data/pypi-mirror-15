...
class ActionWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.modified_bonds is not None:
            HostNicWriter.write_many(obj.modified_bonds, writer, 'modified_bond', 'modified_bonds')
        if obj.modified_labels is not None:
            NetworkLabelWriter.write_many(obj.modified_labels, writer, 'modified_label', 'modified_labels')
        if obj.modified_network_attachments is not None:
            NetworkAttachmentWriter.write_many(obj.modified_network_attachments, writer, 'modified_network_attachment', 'modified_network_attachments')
        ...
        if obj.removed_bonds is not None:
            HostNicWriter.write_many(obj.removed_bonds, writer, 'removed_bond', 'removed_bonds')
        if obj.removed_labels is not None:
            NetworkLabelWriter.write_many(obj.removed_labels, writer, 'removed_label', 'removed_labels')
        if obj.removed_network_attachments is not None:
            NetworkAttachmentWriter.write_many(obj.removed_network_attachments, writer, 'removed_network_attachment', 'removed_network_attachments')
        ...
        if obj.synchronized_network_attachments is not None:
            NetworkAttachmentWriter.write_many(obj.synchronized_network_attachments, writer, 'synchronized_network_attachment', 'synchronized_network_attachments')
...
class BondingWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.slaves is not None:
            HostNicWriter.write_many(obj.slaves, writer, 'slave', 'slaves')
        writer.write_end()
...
class ClusterWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.supported_versions is not None:
            VersionWriter.write_many(obj.supported_versions, writer, 'supported_version', 'supported_versions')
...
class DnsWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.search_domains is not None:
            HostWriter.write_many(obj.search_domains, writer, 'search_domain', 'search_domains')
        if obj.servers is not None:
            HostWriter.write_many(obj.servers, writer, 'server', 'servers')
        writer.write_end()
...
class ExternalHostProviderWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.compute_resources is not None:
            ExternalComputeResourceWriter.write_many(obj.compute_resources, writer, 'compute_resource', 'compute_resources')
        if obj.discovered_hosts is not None:
            ExternalDiscoveredHostWriter.write_many(obj.discovered_hosts, writer, 'discovered_host', 'discovered_hosts')
        if obj.host_groups is not None:
            ExternalHostGroupWriter.write_many(obj.host_groups, writer, 'host_group', 'host_groups')
        if obj.hosts is not None:
            HostWriter.write_many(obj.hosts, writer, 'host', 'hosts')
        writer.write_end()
...
class HostWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.storages is not None:
            HostStorageWriter.write_many(obj.storages, writer, 'storage', 'storages')
        if obj.tags is not None:
            TagWriter.write_many(obj.tags, writer, 'tag', 'tags')
...
class NicWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.virtual_function_allowed_labels is not None:
            NetworkLabelWriter.write_many(obj.virtual_function_allowed_labels, writer, 'virtual_function_allowed_label', 'virtual_function_allowed_labels')
        if obj.virtual_function_allowed_networks is not None:
            NetworkWriter.write_many(obj.virtual_function_allowed_networks, writer, 'virtual_function_allowed_network', 'virtual_function_allowed_networks')
        if obj.vm is not None:
            VmWriter.write_one(obj.vm, writer, 'vm')
        if obj.vms is not None:
            VmWriter.write_many(obj.vms, writer, 'vm', 'vms')
...
class OpenStackImageProviderWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.images is not None:
            OpenStackImageWriter.write_many(obj.images, writer, 'image', 'images')
        writer.write_end()
...
class OpenStackNetworkProviderWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.certificates is not None:
            CertificateWriter.write_many(obj.certificates, writer, 'certificate', 'certificates')
        if obj.networks is not None:
            OpenStackNetworkWriter.write_many(obj.networks, writer, 'network', 'networks')
        if obj.subnets is not None:
            OpenStackSubnetWriter.write_many(obj.subnets, writer, 'subnet', 'subnets')
        writer.write_end()
...
class OpenStackVolumeProviderWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.authentication_keys is not None:
            OpenstackVolumeAuthenticationKeyWriter.write_many(obj.authentication_keys, writer, 'authentication_key', 'authentication_keys')
        if obj.certificates is not None:
            CertificateWriter.write_many(obj.certificates, writer, 'certificate', 'certificates')
        if obj.data_center is not None:
            DataCenterWriter.write_one(obj.data_center, writer, 'data_center')
        if obj.volume_types is not None:
            OpenStackVolumeTypeWriter.write_many(obj.volume_types, writer, 'volume_type', 'volume_types')
        writer.write_end()
...
class VlanWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if href is not None:
            writer.write_attribute('href', href)
        if obj.id is not None:
            writer.write_attribute('id', obj.id.to_s)
        writer.write_end()

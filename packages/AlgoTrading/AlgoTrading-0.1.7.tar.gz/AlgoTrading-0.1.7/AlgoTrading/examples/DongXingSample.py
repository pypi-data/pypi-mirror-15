...
def run_example():
    ...
    # futures to trade
    ihs = ['ih15%02d.cffex' % i for i in range(5, 13)] + ['ih16%02d.cffex' % i for i in range(1, 6)]
    ifs = ['if15%02d.cffex' % i for i in range(5, 13)] + ['if16%02d.cffex' % i for i in range(1, 6)]
    ics = ['ic15%02d.cffex' % i for i in range(5, 13)] + ['ic16%02d.cffex' % i for i in range(1, 6)]

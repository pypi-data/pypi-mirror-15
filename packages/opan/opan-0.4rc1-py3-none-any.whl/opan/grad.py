 ...
 *  Subclasses MAY define an unlimited number of methods, class variables,
    and/or instance variables of
    unrestricted type, in addition to those defined above.
...
class SuperOpanGrad(object):
    ...
    and type-enforcement during development of subclasses for newly
    implemented  external software packages, rather than

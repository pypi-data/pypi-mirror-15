...
# Private 
    ...
    def Mobile_Swipe_In_Element(self, locator, num=1):
        """Swipe submenu's clickable elements into the screen.
           inputs: submenu's Element locator, target_num
           return: Null.Just preform swipe on the target erea. 
        """
        self.wait_until_page_contains_element(locator)
        element = self._get_selected_element(locator, num)

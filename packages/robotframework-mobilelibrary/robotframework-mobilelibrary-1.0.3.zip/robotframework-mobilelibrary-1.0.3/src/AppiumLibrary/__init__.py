...
class AppiumLibrary(
    ...
    *Locating elements*
    ...
    def __init__(self, timeout=5, run_on_failure='Capture Page Screenshot',gen_gif_flag=False):
        ...
        if gen_gif_flag=='True':
            self.ROBOT_LIBRARY_LISTENER = LibraryListener()
            BuiltIn().set_global_variable('${gen_gif}',gen_gif_flag)

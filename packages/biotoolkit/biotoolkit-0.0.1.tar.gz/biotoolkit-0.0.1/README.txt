...
percentage GC-content for each sequence, and saves this data as a csv file with the original 
name (e.g., fasta_file_1.fa --> fasta_file_1.csv). 
...
Upon successful installation, the module can be imported into new python scripts with:
	...
	from biotools import GCfromDNA

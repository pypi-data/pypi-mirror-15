...
__date__    = '2016-June-18'   
__url__     = 'https://engineering.purdue.edu/kak/distWatershed/Watershed-2.0.2.html'
...
CHANGE LOG:
  ...
  Version 2.0.2
    ...
    pairs. If you supply the filter as a triple of three scalar values,
...
CONSTRUCTOR PARAMETERS: 
    ...
    color_filter: The color filter can be specified in one of two different
                   ...
                   you supply the filter as a triple of three scalar
...
PUBLIC METHODS:
    ...
    (4)  compute_Z_level_sets_for_gradient_image()
    ...
    (11) display_watershed_contours_in_color()
    ...
    (15) extract_image_region_interactively_through_mouse_clicks():
    ...
    (16) extract_image_region_interactively_by_dragging_mouse():
    ...
    (17) extract_rectangular_masked_segment_of_image(self, horiz_start, horiz_end, vert_start, vert_end)
    ...
    (18) extract_segmented_blobs_using_contours( min_length )
    ...
    (19) extract_segmented_blobs_using_region_growing( num_of_segments, min_area )
    ...
    (20) extract_watershed_contours_with_random_sampling( how_many, min_len )
    ...
    (21) extract_watershed_contours_separated()
    ...
    (22) gendata(feature, size_tuple, location_tuple, orientation_or_radius, filename)
    ...
    (23) make_binary_pic_art_nouveau( filename )
    ...
    (24) mark_image_regions_for_gradient_mods()
    ...
    (25) modify_gradients_with_marker_minima()
    ...
    (26) propagate_influence_zones_from_bottom_to_top_of_Z_levels()
...
class Watershed(object):
    ...
    def apply_color_filter_rgb(self):
        ...
        self.displayImage3(new_image, "color filtered image -- close window when done viewing")

...
setup(name='Watershed',
      ...
      url='https://engineering.purdue.edu/kak/distWatershed/Watershed-2.0.2.html',
      download_url='https://engineering.purdue.edu/kak/distWatershed/Watershed-2.0.2.tar.gz',
      description='An image segmentation algorithm based on the watershed paradigm',
      long_description='''

Consult the module API page at

      https://engineering.purdue.edu/kak/distWatershed/Watershed-2.0.2.html

...
__date__    = '2016-June-10'
__url__     = 'https://engineering.purdue.edu/kak/distWatershed/Watershed-2.0.1.html'
...
PUBLIC METHODS:
    ...
    (9)  display_watershed_contours_in_color()
    ...
    (13) extract_rectangular_masked_segment_of_image(self, horiz_start, horiz_end, vert_start, vert_end)
    ...
    (14) extract_segmented_blobs_using_contours( min_length )
    ...
    (15) extract_segmented_blobs_using_region_growing( num_of_segments, min_area )
    ...
    (16) extract_watershed_contours_with_random_sampling( how_many, min_len )
    ...
    (17) extract_watershed_contours_separated()
    ...
    (18) gendata(feature, size_tuple, location_tuple, orientation_or_radius, filename)
    ...
    (19) make_binary_pic_art_nouveau( filename )
    ...
    (20) mark_image_regions_for_gradient_mods()
    ...
    (21) modify_gradients_with_marker_minima()
    ...
    (22) propagate_influence_zones_from_bottom_to_top_of_Z_levels()
        ...
        if args:
            raise ValueError(  
                   '''Watershed constructor can only be called with keyword arguments for 
                      ...
                      sigma, and debug''')   
        data_image = sigma = size_for_calculations = padding = None

...
class Lattice(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, dim=100, length=20., periodic_x_axis=False, periodic_y_axis=False, angular_velocity=0.): 
        """
        Lattice constructor.  
        ...
        * `Lattice` : Lattice object 
        ...
        """
        this = _trottersuzuki.new_Lattice(dim, length, periodic_x_axis, periodic_y_axis, angular_velocity)

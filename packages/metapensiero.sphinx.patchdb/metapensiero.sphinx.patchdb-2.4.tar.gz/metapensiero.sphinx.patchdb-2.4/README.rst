...
followed by alphanumerics), while its value may contain whitespaces, letters or digits.
...
* any `database supported`__ by SQLAlchemy_ (but some features don't work)

.. _fdb: https://pypi.python.org/pypi/fdb
.. _PyMySQL: https://pypi.python.org/pypi/PyMySQL
.. _psycopg2: https://pypi.python.org/pypi/psycopg2
.. _SQLAlchemy: http://www.sqlalchemy.org/
__ http://docs.sqlalchemy.org/en/rel_1_0/core/engines.html#supported-databases

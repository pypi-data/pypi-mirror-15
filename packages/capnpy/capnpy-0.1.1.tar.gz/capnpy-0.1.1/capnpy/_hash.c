...
static PyObject *__pyx_pf_6capnpy_5_hash_inthash(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_v); /* proto */
static PyObject *__pyx_pf_6capnpy_5_hash_2longhash(CYTHON_UNUSED PyObject *__pyx_self, unsigned long __pyx_v_v); /* proto */
static PyObject *__pyx_pf_6capnpy_5_hash_4strhash(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, long __pyx_v_start, long __pyx_v_size); /* proto */
...
static PyObject *__pyx_pw_6capnpy_5_hash_1inthash(PyObject *__pyx_self, PyObject *__pyx_arg_v); /*proto*/
...
/* Python wrapper */
static PyObject *__pyx_pw_6capnpy_5_hash_1inthash(PyObject *__pyx_self, PyObject *__pyx_arg_v); /*proto*/
static PyObject *__pyx_pw_6capnpy_5_hash_1inthash(PyObject *__pyx_self, PyObject *__pyx_arg_v) {
  long __pyx_v_v;
  int __pyx_lineno = 0;
  ...
  assert(__pyx_arg_v); {
    __pyx_v_v = __Pyx_PyInt_As_long(__pyx_arg_v); if (unlikely((__pyx_v_v == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_r = __pyx_pf_6capnpy_5_hash_inthash(__pyx_self, ((long)__pyx_v_v));
...
static PyObject *__pyx_pf_6capnpy_5_hash_inthash(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_v) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_inthash(__pyx_v_v, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pw_6capnpy_5_hash_3longhash(PyObject *__pyx_self, PyObject *__pyx_arg_v); /*proto*/
 ...
 * 
 */
  __pyx_r = __pyx_f_6capnpy_5_hash_inthash(((long)__pyx_v_v), 0);
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_6capnpy_5_hash_3longhash(PyObject *__pyx_self, PyObject *__pyx_arg_v); /*proto*/
static PyObject *__pyx_pw_6capnpy_5_hash_3longhash(PyObject *__pyx_self, PyObject *__pyx_arg_v) {
  ...
  assert(__pyx_arg_v); {
    __pyx_v_v = __Pyx_PyInt_As_unsigned_long(__pyx_arg_v); if (unlikely((__pyx_v_v == (unsigned long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6capnpy_5_hash_2longhash(__pyx_self, ((unsigned long)__pyx_v_v));
...
static PyObject *__pyx_pf_6capnpy_5_hash_2longhash(CYTHON_UNUSED PyObject *__pyx_self, unsigned long __pyx_v_v) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("longhash", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_longhash(__pyx_v_v, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6capnpy_5_hash_5strhash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
 ...
 */
  ...
  __pyx_t_1 = PyBytes_GET_SIZE(__pyx_v_a); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef long x
 */
  __pyx_t_4 = __Pyx_PyObject_AsUString(__pyx_v_a); if (unlikely((!__pyx_t_4) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_p = __pyx_t_4;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("capnpy._hash.strhash", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_6capnpy_5_hash_5strhash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6capnpy_5_hash_5strhash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("strhash (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "strhash") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_start = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_start == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_size = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_size == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("strhash", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("capnpy._hash.strhash", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), (&PyBytes_Type), 1, "a", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6capnpy_5_hash_4strhash(__pyx_self, __pyx_v_a, __pyx_v_start, __pyx_v_size);
...
static PyObject *__pyx_pf_6capnpy_5_hash_4strhash(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, long __pyx_v_start, long __pyx_v_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("strhash", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash_strhash(__pyx_v_a, __pyx_v_start, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return tuplehash(a.data.as_longs, len(a))             # <<<<<<<<<<<<<<
 */
  __pyx_t_3 = Py_SIZE(((PyObject *)__pyx_v_a)); if (unlikely(__pyx_t_3 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_WriteUnraisable("capnpy._hash.__tuplehash_for_tests", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pf_6capnpy_5_hash_6__tuplehash_for_tests(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_hashes) {
  ...
  __Pyx_RefNannySetupContext("__tuplehash_for_tests", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_6capnpy_5_hash___tuplehash_for_tests(__pyx_v_hashes, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"inthash", (PyCFunction)__pyx_pw_6capnpy_5_hash_1inthash, METH_O, 0},
  {"longhash", (PyCFunction)__pyx_pw_6capnpy_5_hash_3longhash, METH_O, 0},
  {"strhash", (PyCFunction)__pyx_pw_6capnpy_5_hash_5strhash, METH_VARARGS|METH_KEYWORDS, 0},
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "capnpy._hash")) {
      if (unlikely(PyDict_SetItemString(modules, "capnpy._hash", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("inthash", (void (*)(void))__pyx_f_6capnpy_5_hash_inthash, "long (long, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("longhash", (void (*)(void))__pyx_f_6capnpy_5_hash_longhash, "long (unsigned long, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("tuplehash", (void (*)(void))__pyx_f_6capnpy_5_hash_tuplehash, "long (long *, long)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("strhash", (void (*)(void))__pyx_f_6capnpy_5_hash_strhash, "long (PyObject *, long, long, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
 ...
 *     cdef array.array a = array.array('l', hashes)
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_array, 0, -1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_array, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

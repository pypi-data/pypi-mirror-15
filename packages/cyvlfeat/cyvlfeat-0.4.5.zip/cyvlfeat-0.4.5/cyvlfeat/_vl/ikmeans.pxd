...
cdef extern from "vl/ikmeans.h":
    ...
    void vl_ikm_init_rand_data (VlIKMFilt *f, vl_uint8* data, vl_size M, vl_size N, vl_size K)
    int  vl_ikm_train (VlIKMFilt *f, vl_uint8* data, vl_size N)
    void vl_ikm_push (VlIKMFilt *f, vl_uint32 *asgn, vl_uint8* data, vl_size N)
    vl_uint vl_ikm_push_one (vl_ikmacc_t* centers, vl_uint8* data, vl_size M, vl_size K)

...
from .mathop cimport VlFloatVectorComparisonFunction, VlDoubleVectorComparisonFunction, VlVectorComparisonType
...
cdef extern from "vl/kmeans.h":
    ...
    cdef enum _VlKMeansInitialization:
        ...
        VlKMeansPlusPlus = 1          # Plus plus raondomized selection
    ...
    inline void vl_kmeans_set_algorithm (VlKMeans * self, VlKMeansAlgorithm algorithm)
    inline void vl_kmeans_set_initialization (VlKMeans * self, VlKMeansInitialization initialization)
    inline void vl_kmeans_set_num_repetitions (VlKMeans * self, vl_size numRepetitions)
    inline void vl_kmeans_set_max_num_iterations (VlKMeans * self, vl_size maxNumIterations)
    inline void vl_kmeans_set_min_energy_variation (VlKMeans * self, double minEnergyVariation)
    inline void vl_kmeans_set_verbosity (VlKMeans * self, int verbosity)
    inline void vl_kmeans_set_max_num_comparisons (VlKMeans * self, vl_size maxNumComparisons)

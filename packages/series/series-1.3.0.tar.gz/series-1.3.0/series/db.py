...
class Database(SPDatabase):
    ...
    def connect(self, create=True):
        super(Database, self).__init__(self.url,
    ...
    def commit(self):
        if self._connected:
            ...
            logger.error('Tried to commit while not connected!')
...
class FileDatabase(Database):
    ...
    def __init__(self, root_module, _path, **kw):
        ...
        super(FileDatabase, self).__init__(root_module, connection_string,
                                           **kw)
    ...
    def _check_path(self):
        ...
        self._new_db = not os.path.isfile(self._path)
    ...
    def upgrade(self, revision):
        ...
        if self._new_db:
            ...
            super(FileDatabase, self).upgrade(revision)


__all__ = ['Database', 'Column', 'Integer', 'Boolean', 'FileDatabase',
           'String', 'Float']

...
def create(name, description, tags, project, cpu, ram, image, external_image, script, interactive, root, volume, array, login, label, parent, tmp_storage, env, cmd, wait):
    """ create a new job """

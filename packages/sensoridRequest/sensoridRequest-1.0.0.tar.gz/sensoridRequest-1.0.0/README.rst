...
-Tracking Sensor ID:
  ...
  call to the carbon black web api & return the sensor ID from the a list of all  sensors where the computer name of the sensor matches the computer name of the  system being installed currently.

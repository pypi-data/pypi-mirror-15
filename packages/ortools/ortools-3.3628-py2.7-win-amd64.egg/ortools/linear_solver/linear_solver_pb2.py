...
_MPSOLVERRESPONSESTATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MPSOLVER_MODEL_INVALID_NUM_VARS_AND_NUM_COEFFS_DIFFER_IN_CONSTRAINT', index=12, number=81,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MPSOLVER_MODEL_INVALID_VAR_INDEX_OUT_OF_RANGE_IN_CONSTRAINT', index=13, number=82,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MPSOLVER_MODEL_INVALID_DUPLICATE_VAR_IN_CONSTRAINT', index=14, number=83,
      options=None,
      type=None),
  ],

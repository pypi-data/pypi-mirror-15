...
_ANYVALUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type_url', full_name='AnyValue.type_url', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='AnyValue.value', index=1,
...
AnyValue = _reflection.GeneratedProtocolMessageType('AnyValue', (_message.Message,), dict(
  DESCRIPTOR = _ANYVALUE,
  __module__ = 'grr.proto.semantic_pb2'
...
google.protobuf.descriptor_pb2.EnumValueOptions.RegisterExtension(label)

...
# client program (if it stores DispyJob instances). This can take up memory at
# the client, causing issues especially when submitting many jobs.
...
# the cluster, and 'uppper_bound' to, say, 3x that.

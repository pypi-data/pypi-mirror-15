...
Please refer to the exising configs in ``/work/code/workload-automation/wlauto/workloads/rt_app/use_cases`` for more examples.
...
config : str  
    ...
    included with the workload: video-short.json, browser-long.json, browser-short.json, video-long.json, mp3-short.json, mp3-long.json, taskset.json, spreading-tasks.json

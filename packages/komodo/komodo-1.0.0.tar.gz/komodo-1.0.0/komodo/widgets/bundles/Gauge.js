...
/***/ function(module, exports, __webpack_require__) {
	...
	var _komodo = __webpack_require__(6);

	var _reactChartist = __webpack_require__(106);

	var _reactChartist2 = _interopRequireDefault(_reactChartist);

	var _chartist = __webpack_require__(108);

	var _chartist2 = _interopRequireDefault(_chartist);

	var _Gauge = __webpack_require__(109);
	...
	var Gauge = exports.Gauge = function (_Component) {
	  ...
	  _createClass(Gauge, [{
	    ...
	    value: function render() {
	      ...
	      var lastUpdated = this.props.lastUpdated ? new Date(this.props.lastUpdated) : null;
	      ...
	      var val = Math.min(value, max);
	      var dataset = {
	        series: [val, max - val]
	      };

	      var backgroundColor = value < threshold ? '#1d8147' : '#e74c3c';

	      return _react2.default.createElement(
	        _komodo.WidgetBox,
	        { className: _Gauge2.default.container, color: backgroundColor },
	        _react2.default.createElement(
	          'h1',
	          { className: _Gauge2.default.heading },
	          title
	        ),
	        _react2.default.createElement(_reactChartist2.default, { className: 'ct-octave', data: dataset, options: chartConfig, type: 'Pie' }),
	        _react2.default.createElement(
	          'span',
	          { className: _Gauge2.default.value },
	          prefix,
	          value,
	          suffix
	        ),
	        lastUpdated ? _react2.default.createElement(
	          'small',
	          { className: _Gauge2.default.last_updated },
	          'Last updated ',
	...
	var ChartistGraph = (function (_Component) {
	  ...
	  _createClass(ChartistGraph, [{
	    ...
	    value: function updateChart(config) {
	      var Chartist = __webpack_require__(108);
...
/***/ function(module, exports) {
	...
	module.exports = komodo.ReactDOM;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?modules!./Gauge.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?modules!./Gauge.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n._2gbiSqLBsebA1279wpXM_w {\n  /* Make the content in the middle */\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  color: white;\n}\n\n._24nrlqktm1kodVK85MSDlM {\n  font-size: 38px;\n  font-weight: bold;\n  text-align: center;\n  color: white;\n}\n\n._3S5AzmEPTDYk5HkijMZK74 {\n  font-size: 55px;\n  font-weight: bold;\n  text-align: center;\n  display: block;\n  position: absolute;\n  top: 50%;\n  text-align: center;\n  width: 100%;\n}\n\n._30IpvDFdiK4sNw9zFsmvig {\n  display: block;\n  font-size: 35px;\n  text-align: center;\n}\n\n._2TrNvehopk-ApGwBB-TVdn {\n  position: absolute;\n  bottom: 12px;\n  text-align: center;\n  width: 100%;\n  padding: 0;\n  margin: 0;\n}\n\n.ct-series-a .ct-slice-donut {\n  stroke: white;\n}\n\n.ct-series-b  .ct-slice-donut {\n  stroke: rgba(22, 22, 22, 0.4);\n}\n", ""]);

	// exports
	exports.locals = {
		"container": "_2gbiSqLBsebA1279wpXM_w",
		"heading": "_24nrlqktm1kodVK85MSDlM",
		"value": "_3S5AzmEPTDYk5HkijMZK74",
		"last": "_30IpvDFdiK4sNw9zFsmvig",
		"last_updated": "_2TrNvehopk-ApGwBB-TVdn"
	};

...
def GSL_integrate_qag(Func, a, b, prec=1.e-2, limit_size=1000, rule=6):
    return _CosmoBolognaLib.GSL_integrate_qag(Func, a, b, prec, limit_size, rule)
GSL_integrate_qag = _CosmoBolognaLib.GSL_integrate_qag

def GSL_integrate_qaws(Func, a, b, alpha=0, beta=0, mu=1, nu=0, prec=1.e-2, limit_size=1000):
    return _CosmoBolognaLib.GSL_integrate_qaws(Func, a, b, alpha, beta, mu, nu, prec, limit_size)
GSL_integrate_qaws = _CosmoBolognaLib.GSL_integrate_qaws

def GSL_integrate_qagiu(Func, a, prec=1.e-2, limit_size=1000):
    return _CosmoBolognaLib.GSL_integrate_qagiu(Func, a, prec, limit_size)
GSL_integrate_qagiu = _CosmoBolognaLib.GSL_integrate_qagiu

def generic_integrand(xx, params):
    return _CosmoBolognaLib.generic_integrand(xx, params)
generic_integrand = _CosmoBolognaLib.generic_integrand

def generic_roots(xx, params):
    return _CosmoBolognaLib.generic_roots(xx, params)
generic_roots = _CosmoBolognaLib.generic_roots

def GSL_brent(Func, low_guess, up_guess, prec=1.e-3):
    return _CosmoBolognaLib.GSL_brent(Func, low_guess, up_guess, prec)
GSL_brent = _CosmoBolognaLib.GSL_brent
...
def D1(arg1, arg2, arg3, arg4, arg5):
    return _CosmoBolognaLib.D1(arg1, arg2, arg3, arg4, arg5)
D1 = _CosmoBolognaLib.D1

def D2(arg1, arg2, arg3, arg4, arg5):
    return _CosmoBolognaLib.D2(arg1, arg2, arg3, arg4, arg5)
D2 = _CosmoBolognaLib.D2

def Deriv(arg1, arg2, arg3, arg4, arg5, stepsize=1.):
    return _CosmoBolognaLib.Deriv(arg1, arg2, arg3, arg4, arg5, stepsize)
...
def Xi02_AP(alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2):
    return _CosmoBolognaLib.Xi02_AP(alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2)
Xi02_AP = _CosmoBolognaLib.Xi02_AP

def Xi024_AP(alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2, Xi4):
    return _CosmoBolognaLib.Xi024_AP(alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2, Xi4)
Xi024_AP = _CosmoBolognaLib.Xi024_AP

def XiWedges_AP(mu_min, delta_mu, alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2, Xi4):
    return _CosmoBolognaLib.XiWedges_AP(mu_min, delta_mu, alpha_perpendicular, alpha_parallel, rr, rl, Xi0, Xi2, Xi4)
...
def Covariance_XiMultipoles(nbin, rMin, rMax, nObjects, Volume, kk, Pk_multipoles, orders):
    return _CosmoBolognaLib.Covariance_XiMultipoles(nbin, rMin, rMax, nObjects, Volume, kk, Pk_multipoles, orders)
Covariance_XiMultipoles = _CosmoBolognaLib.Covariance_XiMultipoles

def Covariance_XiWedges(mu, delta_mu, nbin, rMin, rMax, nObjects, Volume, kk, Pk_multipoles, orders):
    return _CosmoBolognaLib.Covariance_XiWedges(mu, delta_mu, nbin, rMin, rMax, nObjects, Volume, kk, Pk_multipoles, orders)
Covariance_XiWedges = _CosmoBolognaLib.Covariance_XiWedges
class STR_generic_integrand(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, STR_generic_integrand, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, STR_generic_integrand, name)
    __repr__ = _swig_repr
    __swig_setmethods__["f"] = _CosmoBolognaLib.STR_generic_integrand_f_set
    __swig_getmethods__["f"] = _CosmoBolognaLib.STR_generic_integrand_f_get
    if _newclass:
        f = _swig_property(_CosmoBolognaLib.STR_generic_integrand_f_get, _CosmoBolognaLib.STR_generic_integrand_f_set)

    def __init__(self):
        this = _CosmoBolognaLib.new_STR_generic_integrand()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _CosmoBolognaLib.delete_STR_generic_integrand
    __del__ = lambda self: None
STR_generic_integrand_swigregister = _CosmoBolognaLib.STR_generic_integrand_swigregister
STR_generic_integrand_swigregister(STR_generic_integrand)

class STR_generic_roots(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, STR_generic_roots, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, STR_generic_roots, name)
    __repr__ = _swig_repr
    __swig_setmethods__["f"] = _CosmoBolognaLib.STR_generic_roots_f_set
    __swig_getmethods__["f"] = _CosmoBolognaLib.STR_generic_roots_f_get
    if _newclass:
        f = _swig_property(_CosmoBolognaLib.STR_generic_roots_f_get, _CosmoBolognaLib.STR_generic_roots_f_set)
    __swig_setmethods__["xx0"] = _CosmoBolognaLib.STR_generic_roots_xx0_set
    __swig_getmethods__["xx0"] = _CosmoBolognaLib.STR_generic_roots_xx0_get
    if _newclass:
        xx0 = _swig_property(_CosmoBolognaLib.STR_generic_roots_xx0_get, _CosmoBolognaLib.STR_generic_roots_xx0_set)

    def __init__(self):
        this = _CosmoBolognaLib.new_STR_generic_roots()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _CosmoBolognaLib.delete_STR_generic_roots
    __del__ = lambda self: None
STR_generic_roots_swigregister = _CosmoBolognaLib.STR_generic_roots_swigregister
STR_generic_roots_swigregister(STR_generic_roots)
...
class Model(_object):
    ...
    def update_parameter(self, new_parameter):
        return _CosmoBolognaLib.Model_update_parameter(self, new_parameter)

    def update_parameters(self, new_parameters):
        return _CosmoBolognaLib.Model_update_parameters(self, new_parameters)

    def set_chains(self, nchains, chain_size):
        return _CosmoBolognaLib.Model_set_chains(self, nchains, chain_size)

    def set_random_number_generator(self, generator):
        return _CosmoBolognaLib.Model_set_random_number_generator(self, generator)
...
_CosmoBolognaLib._createRandom_box_RADec__swigconstant(_CosmoBolognaLib)
_createRandom_box_RADec_ = _CosmoBolognaLib._createRandom_box_RADec_
...
class TwoPointCorrelation(_object):
    ...
    def write(self, dir, file, rank=0):
        return _CosmoBolognaLib.TwoPointCorrelation_write(self, dir, file, rank)

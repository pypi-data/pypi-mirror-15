...
class ExportTemplate(object):
    ...
    def query(self):
        ...
        a SQL query used to generate results to be inserted into the `EXTERNAL TABLE`
    ...
    def sink_query(self):
        ...
        A `CREATE EXTERNAL TABLE` statement that is used to represent the physically stored data results of the query.

...
class GatewayCostElectricalDemand(GatewayBase):

    def __init__(self, endpoint, http_management=None):
        call = "cost/electrical/demand"
        super(GatewayCostElectricalDemand, self).__init__(endpoint, call, http_management=http_management)
    ...
    def _basic_fetch(self, token, parameters, list_consumption):
        ...
        new_consumption = super(GatewayCostElectricalDemand, self).fetch(token, params)

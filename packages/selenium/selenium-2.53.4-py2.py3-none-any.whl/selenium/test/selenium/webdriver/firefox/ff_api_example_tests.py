...
from selenium.test.selenium.webdriver.common import api_example_tests
...
def setup_module(module):
    ...
    FirefoxApiExampleTest.driver = webdriver.Firefox(capabilities={'marionette': False})


class FirefoxApiExampleTest(api_example_tests.ApiExampleTest):
    pass

...
def setup_module(module):
    ...
    webserver.start()
    RemoteClickTest.webserver = webserver
    RemoteClickTest.driver = webdriver.Remote(desired_capabilities=webdriver.DesiredCapabilities.FIREFOX)


class RemoteClickTest(click_tests.ClickTest):
    pass


def teardown_module(module):
    try:
        RemoteClickTest.webserver.stop()
    except AttributeError:
        pass

    RemoteClickTest.driver.quit()

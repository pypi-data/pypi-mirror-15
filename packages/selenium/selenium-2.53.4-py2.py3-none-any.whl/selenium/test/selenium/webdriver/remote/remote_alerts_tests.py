...
def setup_module(module):
    ...
    webserver.start()
    RemoteAlertsTest.webserver = webserver
    RemoteAlertsTest.driver = webdriver.Remote(desired_capabilities=webdriver.DesiredCapabilities.FIREFOX)


class RemoteAlertsTest(alerts_tests.AlertsTest):
    pass


def teardown_module(module):
    try:
        RemoteAlertsTest.webserver.stop()
    except AttributeError:
        pass

    RemoteAlertsTest.driver.quit()

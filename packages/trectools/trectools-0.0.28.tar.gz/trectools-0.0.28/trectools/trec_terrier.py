...
class TrecTerrier:
    ...
    def run(self, index, topics, debug=True, model="PL2", results_dir=None, results_file="trec_terrier.run", terrierc=1, qexp=False, expTerms=5, expDocs=3, expModel="Bo1", showoutput=False):

...
class TrecQrel:
    ...
    def get_judgements(self, indict=None, inpandas=None):
        # TODO
        if indicit is None and inpandas is None:
            print """You should set a dict (indicit) like {'topic':['doc1','doc2'...]...}
                    or a pandas dataframe (inpandas) like [topic,doc].
                  """
            return None

...
class Gmail:
    ...
    def set_credentials(self, credential_file_fp):
        self._credentials_file = path.join(credential_file_fp, 'fattywhitysmarty.credentials')
        return self

    def get_credentials(self):
        if self._credentials_file != '.':
            self._credentials_file = pkg_resources.resource_filename(self.PACKAGE_NAME, re.sub('@.+$', '', self._sender) + '.credentials')

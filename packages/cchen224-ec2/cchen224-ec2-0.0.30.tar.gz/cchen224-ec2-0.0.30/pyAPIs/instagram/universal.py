    ...
    def request(self, user_id, generator):
        ...
        while True:
            ...
            try:
                ...
                is_continue = False
                Gmail(0).set_from_to().set_subject('AWS Instagram' + self._extention + ' Stopped!')\
                    .send_message(user_id + '@access_token ' + str(self._account))
                continue
            except StopIteration:
                return is_continue
            except Exception:
                Gmail(0).set_from_to().set_subject('AWS Instagram' + self._extention + ' Error!')\

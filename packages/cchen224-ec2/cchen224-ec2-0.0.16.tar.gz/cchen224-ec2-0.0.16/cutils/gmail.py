...
class Gmail:
    ...
    CLIENT_SECRET_FILE = pkg_resources.resource_filename('cutils', 'fattywhitysmarty.json')
    ...
    def get_credentials(self):
        credential_file = pkg_resources.resource_filename('cutils', re.sub('@.+$', '', self._sender) + '.credentials')

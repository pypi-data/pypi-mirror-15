...
class VisitorAdmin(admin.ModelAdmin):
    ...
    list_filter = ('first_time',
                   filters.VisitorHitsListFilter,
                   filters.VisitorVisitsListFilter,
                   filters.InProgressListFilter)
...
class VisitAdmin(admin.ModelAdmin):
    ...
    list_filter = ('first_time', filters.VisitHitsListFilter, filters.InProgressListFilter)
    ...
    def lookup_allowed(self, key, value):
        return key == 'requests__user__username' or super(VisitAdmin, self).lookup_allowed(key, value)

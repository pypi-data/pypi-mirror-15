...
@register.inclusion_tag(filename='django_turnit/snippets/turnit.html', name='turnit', takes_context=True)
...
@register.inclusion_tag(filename='django_turnit/snippets/turnit_modal.html', name='turnit_modal', takes_context=True)

...
def samtools_flagstat(uuid, bam_path, reference_fasta_path, engine, logger):
    ...
    if pipe_util.already_step(step_dir, 'samtools_flagstat_' + bam_base, logger):
        ...
        unique_key_dict = {'uuid': uuid, 'bam_name': bam_name, 'reference_fasta_path': reference_fasta_path}
